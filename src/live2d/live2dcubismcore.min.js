...
!function (Live2DCubismCore) {
    var _scriptDir, _csm = function () {
            function _csm() {
            }

            return _csm.getVersion = function () {
        ...
        Version = (Live2DCubismCore.AlignofMoc = 64, Live2DCubismCore.AlignofModel = 16, Live2DCubismCore.MocVersion_Unknown = 0, Live2DCubismCore.MocVersion_30 = 1, Live2DCubismCore.MocVersion_33 = 2, Live2DCubismCore.MocVersion_40 = 3, Live2DCubismCore.MocVersion_42 = 4, Live2DCubismCore.ParameterType_Normal = 0, Live2DCubismCore.ParameterType_BlendShape = 1, function () {
            function Version() {
            }

            return Version.csmGetVersion = function () {
        ...
        }()), Version = (Live2DCubismCore.Version = Version, function () {
            function Logging() {
            }

            return Logging.csmSetLogFunction = function (handler) {
        ...
        }()), Version = (Live2DCubismCore.Logging = Version, function () {
            ...
            return Moc.fromArrayBuffer = function (buffer) {
        ...
        }()), Version = (Live2DCubismCore.Moc = Version, function () {
            function Model(moc) {
                this._ptr = _csm.mallocModelAndInitialize(moc._ptr), this._ptr && (this.parameters = new Parameters(this._ptr), this.parts = new Parts(this._ptr), this.drawables = new Drawables(this._ptr), this.canvasinfo = new CanvasInfo(this._ptr))
            }

            return Model.fromMoc = function (moc) {
                moc = new Model(moc);
        ...
        }), Parts = (Live2DCubismCore.Parameters = Parameters, function (modelPtr) {
            ...
            function Drawables(modelPtr) {
                ...
                for (var _vertexPositions = new Uint32Array(_em.HEAPU32.buffer, _csm.getDrawableVertexPositions(modelPtr), length), i = 0; i < _vertexPositions.length; i++) this.vertexPositions[i] = new Float32Array(_em.HEAPF32.buffer, _vertexPositions[i], 2 * length2[i]);
                ...
                for (var _vertexUvs = new Uint32Array(_em.HEAPU32.buffer, _csm.getDrawableVertexUvs(modelPtr), length), i = 0; i < _vertexUvs.length; i++) this.vertexUvs[i] = new Float32Array(_em.HEAPF32.buffer, _vertexUvs[i], 2 * length2[i]);
            ...
            return Drawables.prototype.resetDynamicFlags = function () {
                _csm.resetDrawableDynamicFlags(this._modelPtr)
            }, Drawables
        }()), Version = (Live2DCubismCore.Drawables = Drawables, function () {
            function Utils() {
            }

            return Utils.hasBlendAdditiveBit = function (bitfield) {
                return 1 == (1 & bitfield)
        ...
        _em_module = (Live2DCubismCore.Utils = Version, _scriptDir = "undefined" != typeof document && document.currentScript ? document.currentScript.src : void 0, function (_em_module) {
            _em_module = _em_module || {};
            var b, m, e = {};
            for (m in b = b || (void 0 !== _em_module ? _em_module : {})) b.hasOwnProperty(m) && (e[m] = b[m]);
            var w, z, A, v, x, r = !1, n = "object" == typeof window, q = "function" == typeof importScripts,
                r = "object" == typeof process && "object" == typeof process.versions && "string" == typeof process.versions.node && !n && !q,
                t = !n && !r && !q, u = "", G = (r ? (u = __dirname + "/", v = function (a, c) {
                    var d = B(a);
                    ...
                    return c
                }, "undefined" != typeof print && ((console = "undefined" == typeof console ? {} : console).log = print, console.warn = console.error = "undefined" != typeof printErr ? printErr : print)) : (n || q) && (q ? u = self.location.href : document.currentScript && (u = document.currentScript.src), u = 0 !== (u = _scriptDir || u).indexOf("blob:") ? u.substr(0, u.lastIndexOf("/") + 1) : "", v = function (a) {
                    try {
                    ...
                    var c = E, d = F, f = new XMLHttpRequest;
                ...
                }), b.print || console.log.bind(console)), H = b.printErr || console.warn.bind(console);
            for (m in e) e.hasOwnProperty(m) && (b[m] = e[m]);
            var e = null, I = Array(1), J = 0, K = !1;

            function assert(a, c) {
                a || C("Assertion failed: " + c)
            }

            var buffer, N, M, O, L = "undefined" != typeof TextDecoder ? new TextDecoder("utf8") : void 0;
            ...
            "undefined" != typeof TextDecoder && new TextDecoder("utf-16le"), n = b.TOTAL_MEMORY || 16777216, n = (buffer = b.buffer || new ArrayBuffer(n)).byteLength, fa(buffer), O[1052] = 5247296;
            var ia = [], ja = [], ka = [], la = [],
                Q = (Math.imul && -5 === Math.imul(4294967295, 5) || (Math.imul = function (a, c) {
                    var d = 65535 & a, f = 65535 & c;
            ...
            var E = null, U = "data:application/octet-stream;base64,";
            ...
            var ua = "function" == typeof atob ? atob : function (a) {
                ...
                do {
                    var f = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(a.charAt(d++)),
                        ...
                        f = f << 2 | g >> 4, g = (15 & g) << 4 | h >> 2, k = (3 & h) << 6 | p
            ...
            var F, Ca, Y, q = function (global, env, buffer) {
                    var a = new global.Int8Array(buffer), b = new global.Int16Array(buffer),
                        c = new global.Int32Array(buffer), d = new global.Uint8Array(buffer),
                        e = new global.Uint16Array(buffer), f = new global.Float32Array(buffer),
                        g = new global.Float64Array(buffer), h = 0 | env.v, q = global.Math.floor, r = global.Math.pow,
                        s = global.Math.cos, t = global.Math.sin, u = global.Math.atan2, v = global.Math.imul,
                        w = global.Math.clz32, x = env.a, y = env.b, z = env.c, A = env.d, B = env.e, C = env.f, D = env.g,
                        E = env.h, F = env.i, G = env.j, H = env.k, I = env.l, J = env.m, S = 4416;

                    function ea(a) {
                        var b, d, g, h, i, j, n, o, p, q, r, s, t, u, v, w, x, y, k = 0, l = 0,
                            m = 0 | c[500 + (a |= 0) >> 2];
                        if (!((0 | m) <= 0)) {
                    ...
                    function ga(a, b, d, e, g, h) {
                        a |= 0, e |= 0, g |= 0, h |= 0;
                        var l, o, p, q, r, s, t, u, w, i = 0, j = 0, k = 0, m = 0, n = 0, v = S;
                    ...
                    function ia(a, b, d) {
                        a |= 0, b |= 0, d |= 0;
                        var e, f, g = S;
                        S = S + 272 | 0, a = g + 16 | 0, f = g, (e = 0 | c[904]) && (c[f >> 2] = d, _b(a, b, f), Z[1 & e](a)), S = g
                    }

                    function ma(b, d, e) {
                        e |= 0;
                        var m, f = 0, g = 0, h = 0, i = 0, j = 0, k = 0, l = 0, n = 0, o = 0, p = 0,
                            o = 0 | a[4 + (b |= 0) >> 0];
                    ...
                    function na(b, e, g) {
                        ...
                        if (c[Z + 488 >> 2] = e + (0 | c[p + 496 >> 2]), c[Z + 492 >> 2] = e + (0 | c[p + 500 >> 2]), c[Z + 496 >> 2] = e + (0 | c[p + 504 >> 2]), c[(R = Z + 504 | 0) >> 2] = e + (0 | c[p + 508 >> 2]), c[Z + 536 >> 2] = e + (0 | c[p + 512 >> 2]), c[(T = Z + 512 | 0) >> 2] = e + (0 | c[p + 516 >> 2]), c[Z + 520 >> 2] = e + (0 | c[p + 520 >> 2]), c[Z + 524 >> 2] = e + (0 | c[p + 524 >> 2]), c[Z + 528 >> 2] = e + (0 | c[p + 528 >> 2]), c[Z + 532 >> 2] = e + (0 | c[p + 532 >> 2]), z = 3 < (0 | d[(V = b + 4 | 0) >> 0])) {
                            if (c[Z + 576 >> 2] = e + (0 | c[p + 464 >> 2]), c[Z + 584 >> 2] = e + (0 | c[p + 468 >> 2]), h = 0 | c[p + 476 >> 2], j = 0 | c[Y >> 2], l = e + (0 | c[p + 472 >> 2]) | 0, c[Z + 592 >> 2] = l, 0 < (0 | (j = 0 | c[j + 104 >> 2]))) for (k = 0 | c[b + 1080 >> 2], h = e + h | 0, g = 0; c[l + (48 * g | 0) + 40 >> 2] = h, (0 | (i = g + 1 | 0)) != (0 | j);) h = h + (c[k + (g << 2) >> 2] << 2) | 0, g = i;
                        ...
                        if (g = 0 | c[l >> 2], 0 < (0 | (c[(e = Z + 4 | 0) >> 2] = g))) {
                            for (j = 0 | c[D >> 2], o = 0 | c[U >> 2], p = 0 | c[q + 720 >> 2], k = 0 | c[q + 740 >> 2], m = 0 | c[q + 736 >> 2], n = 0 | c[q + 732 >> 2], h = 0 | c[E >> 2], i = g; c[j + (12 * (i = (E = i) + -1 | 0) | 0) >> 2] = o + (36 * (0 | c[p + (i << 2) >> 2]) | 0), c[j + (12 * i | 0) + 4 >> 2] = c[k + (i << 2) >> 2], c[j + (12 * i | 0) + 8 >> 2] = c[m + (i << 2) >> 2], f[h + (i << 2) >> 2] = 0 == (0 | c[n + (i << 2) >> 2]) ? 0 : 1, 1 < (0 | E);) ;
                        ...
                        if (c[Z + 20 >> 2] = h, c[Z + 12 >> 2] = g, h = 0 | c[l + 4 >> 2], 0 < (0 | (c[Z + 304 >> 2] = h))) {
                            m = q + 752 | 0, o = q + 764 | 0, n = q + 768 | 0, l = q + 772 | 0, p = q + 776 | 0, k = q + 760 | 0;
                            do {
                        ...
                        if (i = 0 | c[z + 8 >> 2], h = (c[(e = Z + 56 | 0) >> 2] = i) + -1 | 0, p = 0 < (0 | i)) if (j = 0 | c[L >> 2], k = 0 | c[U >> 2], l = 0 | c[B + 780 >> 2], m = 0 | c[B + 800 >> 2], n = 0 | c[B + 804 >> 2], o = 0 | c[B + 796 >> 2], 1 < (0 | d[B + 4 >> 0])) for (g = 0 | c[B + 808 >> 2]; c[j + (24 * h | 0) >> 2] = k + (36 * (0 | c[l + (h << 2) >> 2]) | 0), c[j + (24 * h | 0) + 4 >> 2] = c[m + (h << 2) >> 2], c[j + (24 * h | 0) + 8 >> 2] = c[n + (h << 2) >> 2], c[j + (24 * h | 0) + 16 >> 2] = c[o + (h << 2) >> 2], c[j + (24 * h | 0) + 12 >> 2] = c[g + (h << 2) >> 2], 0 < (0 | h);) h = h + -1 | 0; else for (; c[j + (24 * h | 0) >> 2] = k + (36 * (0 | c[l + (h << 2) >> 2]) | 0), c[j + (24 * h | 0) + 4 >> 2] = c[m + (h << 2) >> 2], c[j + (24 * h | 0) + 8 >> 2] = c[n + (h << 2) >> 2], c[j + (24 * h | 0) + 16 >> 2] = c[o + (h << 2) >> 2], (c[j + (24 * h | 0) + 12 >> 2] = 0) < (0 | h);) h = h + -1 | 0;
                        if (g = 0 | c[z + 12 >> 2], 0 < (0 | (c[(n = Z + 164 | 0) >> 2] = g))) for (h = 0 | c[J >> 2], j = 0 | c[U >> 2], k = 0 | c[B + 812 >> 2], l = 0 | c[B + 828 >> 2], m = g; c[h + (12 * (m = (H = m) + -1 | 0) | 0) >> 2] = j + (36 * (0 | c[k + (m << 2) >> 2]) | 0), c[h + (12 * m | 0) + 4 >> 2] = c[l + (m << 2) >> 2], 1 < (0 | H);) ;
                        if (p) {
                        ...
                        if (c[Z + 180 >> 2] = h, c[Z + 172 >> 2] = g, A = B + 704 | 0, h = 0 | c[z + 16 >> 2], 0 < (0 | (c[(p = Z + 332 | 0) >> 2] = h))) {
                            for (g = 0 | c[O >> 2], n = 0 | c[U >> 2], o = 0 | c[B + 852 >> 2], i = 0 | c[B + 876 >> 2], j = 0 | c[B + 880 >> 2], k = 0 | c[B + 892 >> 2], l = 0 | c[B + 872 >> 2], m = h; c[g + (20 * (m = (O = m) + -1 | 0) | 0) >> 2] = n + (36 * (0 | c[o + (m << 2) >> 2]) | 0), c[g + (20 * m | 0) + 4 >> 2] = c[i + (m << 2) >> 2], c[g + (20 * m | 0) + 8 >> 2] = c[j + (m << 2) >> 2], c[g + (20 * m | 0) + 16 >> 2] = c[k + (m << 2) >> 2], c[g + (20 * m | 0) + 12 >> 2] = c[l + (m << 2) >> 2], 1 < (0 | O);) ;
                            for (g = 0 | c[N >> 2], i = 0; N = 0 | c[n + (36 * (0 | c[o + ((h = (O = h) + -1 | 0) << 2) >> 2]) | 0) + 8 >> 2], i = (c[g + (h << 2) >> 2] = N) + i | 0, 1 < (0 | O);) ;
                            if (h = 0 | c[p >> 2], c[Z + 348 >> 2] = i, 0 < (0 | (c[Z + 340 >> 2] = h))) for (j = 0 | c[P >> 2], g = 0 | c[Q >> 2], i = h << 2; f[j + ((i = (Q = i) + -4 | 0) << 2) >> 2] = 1, f[j + ((O = Q + -3 | 0) << 2) >> 2] = 1, f[j + ((P = Q + -2 | 0) << 2) >> 2] = 1, f[j + ((Q = Q + -1 | 0) << 2) >> 2] = 1, f[g + (i << 2) >> 2] = 0, f[g + (O << 2) >> 2] = 0, !(((f[g + (P << 2) >> 2] = 0) | h) <= (f[g + (Q << 2) >> 2] = 1));) h = h + -1 | 0
                        } else c[Z + 348 >> 2] = 0, c[Z + 340 >> 2] = h;
                        if (y = 0 | c[z + 72 >> 2], 0 < (0 | (c[Z + 480 >> 2] = y))) {
                            h = 0 | c[M >> 2], g = 0 | c[B + 1152 >> 2], i = 0 | c[B + 1156 >> 2], j = 0 | c[B + 1160 >> 2], k = 0 | c[B + 1164 >> 2], l = 0 | c[B + 1148 >> 2], s = B + 1172 | 0, v = B + 1168 | 0, u = B + 1176 | 0, w = 0;
                            do {
                                if (m = 0 | c[g + (w << 2) >> 2], c[h + (28 * w | 0) + 4 >> 2] = m, c[h + (28 * w | 0) >> 2] = c[i + (w << 2) >> 2], Q = 0 | c[j + (w << 2) >> 2], c[h + (28 * w | 0) + 16 >> 2] = Q, n = 0 | c[k + (w << 2) >> 2], c[h + (28 * w | 0) + 20 >> 2] = n, c[h + (28 * w | 0) + 24 >> 2] = Q + 1 - n, n = (c[h + (28 * w | 0) + 8 >> 2] = 0) | c[l + (w << 2) >> 2], 0 < (0 | m)) for (o = 0 | c[h + (28 * w | 0) + 12 >> 2], p = 0 | c[s >> 2], e = 0 | c[v >> 2], q = 0 | c[u >> 2], x = 0; c[o + (x << 4) + 4 >> 2] = c[p + ((Q = x + n | 0) << 2) >> 2], c[o + (x << 4) >> 2] = c[e + (Q << 2) >> 2], c[o + (x << 4) + 8 >> 2] = c[q + (Q << 2) >> 2], (0 | (x = x + 1 | (c[o + (x << 4) + 12 >> 2] = 0))) != (0 | m);) ;
                            } while ((0 | (w = w + 1 | 0)) != (0 | y))
                        }
                        g = 0 | c[z + 80 >> 2], c[(e = Z + 500 | 0) >> 2] = g;
                        do {
                            if (0 < (0 | g)) {
                                for (n = 0 | c[R >> 2], o = 0 | c[U >> 2], p = 0 | c[B + 1188 >> 2], h = 0 | c[B + 1200 >> 2], i = 0 | c[B + 1204 >> 2], j = 0 | c[B + 1212 >> 2], k = 0 | c[B + 1216 >> 2], l = 0 | c[B + 1208 >> 2], m = 0 | c[B + 1220 >> 2]; c[n + (24 * (g = (U = g) + -1 | 0) | 0) >> 2] = o + (36 * (0 | c[p + (g << 2) >> 2]) | 0), c[n + (24 * g | 0) + 4 >> 2] = c[h + (g << 2) >> 2], c[n + (24 * g | 0) + 8 >> 2] = c[i + (g << 2) >> 2], c[n + (24 * g | 0) + 12 >> 2] = c[j + (g << 2) >> 2], R = 0 | c[l + (g << 2) >> 2], c[n + (24 * g | 0) + 16 >> 2] = k + (R << 2), c[n + (24 * g | 0) + 20 >> 2] = m + (R << 1), 1 < (0 | U);) ;
                                if ((0 | (g = 0 | c[e >> 2])) <= 0) {
                                    h = 0;
                                    break
                                }
                                for (i = 0 | c[T >> 2], h = 0; T = 0 | c[o + (36 * (0 | c[p + ((g = (U = g) + -1 | 0) << 2) >> 2]) | 0) + 8 >> 2], h = (c[i + (g << 2) >> 2] = T) + h | 0, 1 < (0 | U);) ;
                                g = 0 | c[e >> 2]
                            } else h = 0
                        } while (0);
                        ...
                        do {
                            if (3 < (0 | d[V >> 0])) {
                                ...
                                if (g = 0 | c[z + 120 >> 2], 0 < (0 | (c[Z + 572 >> 2] = g))) for (o = 0 | c[Z + 576 >> 2], i = 0 | c[W >> 2], j = 0 | c[B + 1112 >> 2], k = 0 | c[B + 1124 >> 2], l = 0 | c[B + 1116 >> 2], m = 0 | c[B + 1128 >> 2], n = 0 | c[B + 1120 >> 2]; c[o + (20 * (g = (X = g) + -1 | 0) | 0) >> 2] = i + (52 * (0 | c[j + (g << 2) >> 2]) | 0), W = 0 | c[l + (g << 2) >> 2], c[o + (20 * g | 0) + 4 >> 2] = k + (W << 2), c[o + (20 * g | 0) + 8 >> 2] = m + (W << 2), c[o + (20 * g | 0) + 12 >> 2] = c[n + (g << 2) >> 2], 1 < (0 | X);) ;
                                if (g = 0 | c[z + 100 >> 2], 0 < (0 | (c[Z + 580 >> 2] = g))) for (i = 0 | c[Z + 584 >> 2], j = 0 | c[B + 1056 >> 2], k = 0 | c[B + 1132 >> 2], l = 0 | c[B + 1052 >> 2], m = 0 | c[B + 1060 >> 2]; c[i + (28 * (g = (X = g) + -1 | 0) | 0) >> 2] = c[j + (g << 2) >> 2], c[i + (28 * g | 0) + 4 >> 2] = k + (c[l + (g << 2) >> 2] << 2), c[i + (28 * g | 0) + 8 >> 2] = c[m + (g << 2) >> 2], c[i + (28 * g | 0) + 12 >> 2] = 0, f[i + (28 * g | 0) + 16 >> 2] = 0, c[i + (28 * g | 0) + 20 >> 2] = 1, (c[i + (28 * g | 0) + 24 >> 2] = 1) < (0 | X);) ;
                                if (g = 0 | c[z + 104 >> 2], 0 < (0 | (c[Z + 588 >> 2] = g))) {
                                    p = Z + 592 | 0, q = Z + 584 | 0, o = B + 1064 | 0, s = B + 1068 | 0, m = B + 1080 | 0, e = Z + 576 | 0, n = B + 1108 | 0, l = B + 1076 | 0;
                                    do {
                                ...
                                y = B + 948 | 0, z = B + 952 | 0, v = Z + 612 | 0, w = B + 1032 | 0, x = B + 1036 | 0, q = B + 1132 | 0, s = Z + 616 | 0, u = 0;
                                do {
                                    if (h = 0 | c[(0 | c[y >> 2]) + (u << 2) >> 2], p = (b = 0 | c[(0 | c[z >> 2]) + (u << 2) >> 2]) + h | 0, e = 0 | c[(0 | c[v >> 2]) + (u << 2) >> 2], 0 < (0 | b)) {
                                        n = 0 | c[w >> 2], o = 0 | c[x >> 2], m = h, h = 0;
                                        do {
                                            if (g = 0 | c[n + (m << 2) >> 2], l = (b = 0 | c[o + (m << 2) >> 2]) + g | 0, 0 < (0 | b)) {
                                                k = 0 | c[q >> 2];
                                                do {
                                                ...
                                                } while (146 == (0 | X) && (X = 0, f[i >> 2] = t, h = h + 1 | 0), (0 | (g = g + 1 | 0)) < (0 | l))
                                            }
                                        } while ((0 | (m = m + 1 | 0)) < (0 | p))
                                    } else h = 0;
                                    !function (a, b) {
                                        a |= 0;
                                        var h, j, k, m, d = 0, e = 0, f = 0, g = 0, i = 0, l = 0;
                                        S = (m = S) + 208 | 0, f = (b |= 0) << 2, c[(i = k = (j = m) + 192 | 0) >> 2] = 1, c[i + 4 >> 2] = 0;
                                        a:do {
                                            if (0 | f) {
                                                for (c[j + 4 >> 2] = 4, d = b = c[j >> 2] = 4, e = 2; (c[j + (e << 2) >> 2] = b = b + 4 + d | 0) >>> 0 < f >>> 0;) i = d, d = b, e = e + 1 | 0, b = i;
                                                if (a >>> 0 < (g = a + f + -4 | 0) >>> 0) {
                                                    h = g, i = 4 + k | 0, d = a, e = b = 1;
                                                    do {
                                                        do {
                                                            if (3 != (3 & b | 0)) {
                                                                if ((0 | c[j + ((f = e + -1 | 0) << 2) >> 2]) >>> 0 < (h - d | 0) >>> 0 ? xc(d, e, j) : zc(d, b, 0 | c[i >> 2], e, 0, j), 1 == (0 | e)) {
                                                                    Ac(k, 1), e = 0;
                                                                    break
                                                                }
                                                                Ac(k, f), e = 1;
                                                        ...
                                                        } while (xc(d, e, j), yc(k, 2), e = e + 2 | 0, 0)
                                                ...
                                                for (zc(d, b, f, e, 0, j), f = 4 + k | 0; ;) {
                                                    if (1 == (0 | e) & 1 == (0 | b)) {
                                                        if (!(0 | c[f >> 2])) break a;
                                                        l = 21
                                                    } else (0 | e) < 2 ? l = 21 : (Ac(k, 2), a = e + -2 | 0, c[k >> 2] = 7 ^ c[k >> 2], yc(k, 1), zc(d + (0 - (0 | c[j + (a << 2) >> 2])) + -4 | 0, 0 | c[k >> 2], 0 | c[g >> 2], e + -1 | 0, 1, j), Ac(k, 1), b = 1 | c[k >> 2], zc(d = d + -4 | 0, c[k >> 2] = b, 0 | c[g >> 2], a, 1, j), e = a);
                                                    21 == (0 | l) && (yc(k, a = (l = 0) | Bc(k)), b = 0 | c[k >> 2], d = d + -4 | 0, e = a + e | 0)
                                                }
                                            }
                                        } while (0);
                                        S = m
                                    }(e, h), c[(0 | c[s >> 2]) + (u << 2) >> 2] = h, u = u + 1 | 0
                    ...
                    function qa(d) {
                        ...
                        if (0 < (0 | c[e + 20 >> 2])) for (h = d + 920 | 0, i = d + 916 | 0, j = 0; c[(0 | c[i >> 2]) + (j << 2) >> 2] = (0 | c[h >> 2]) + (j << 6), e = 0 | c[g >> 2], (0 | (j = j + 1 | 0)) < (0 | c[e + 20 >> 2]);) ;
                        if (0 < (0 | c[e + 80 >> 2])) for (h = d + 1184 | 0, i = d + 1180 | 0, j = 0; c[(0 | c[i >> 2]) + (j << 2) >> 2] = (0 | c[h >> 2]) + (j << 6), e = 0 | c[g >> 2], (0 | (j = j + 1 | 0)) < (0 | c[e + 80 >> 2]);) ;
                        if (!(1 & a[20 + (0 | c[d + 708 >> 2]) >> 0] || (0 | (m = 0 | c[e + 16 >> 2])) <= 0)) {
                    ...
                    function ra(a) {
                        var b = S;
                        return S = S + 16 | 0, 0 | uc(a |= 0) ? (ia(0, 1210, b), S = b, (a = 0) | a) : (a = 0 | d[a + 4 >> 0], S = b, 0 | a)
                    }

                    function ta(a) {
                        var j, k, l, m, b = 0, e = 0, f = 0, g = 0, h = 0, i = 0, e = 64 + (a |= 0) | 0, b = a + 144 | 0;
                        if (xa(e, 0 | c[a + 88 >> 2], 0 | c[a + 148 >> 2], 0 | c[b >> 2]), za(e, 0 | c[a + 92 >> 2], 0 | c[a + 152 >> 2], 0 | c[796 + (0 | c[a >> 2]) >> 2], 2, 0 | c[b >> 2]), !((0 | d[4 + (0 | c[a >> 2]) >> 0]) < 4 || (xa(e, 0 | c[a + 96 >> 2], 0 | c[(m = a + 120 | 0) >> 2], 0 | c[b >> 2]), xa(e, 0 | c[a + 100 >> 2], 0 | c[(f = a + 124 | 0) >> 2], 0 | c[b >> 2]), xa(e, 0 | c[a + 104 >> 2], 0 | c[(g = a + 128 | 0) >> 2], 0 | c[b >> 2]), xa(e, 0 | c[a + 108 >> 2], 0 | c[(j = a + 132 | 0) >> 2], 0 | c[b >> 2]), xa(e, 0 | c[a + 112 >> 2], 0 | c[(k = a + 136 | 0) >> 2], 0 | c[b >> 2]), xa(e, 0 | c[a + 116 >> 2], 0 | c[(l = a + 140 | 0) >> 2], 0 | c[b >> 2]), b = 0 | c[a + 156 >> 2], e = 0 | c[m >> 2], f = 0 | c[f >> 2], g = 0 | c[g >> 2], (0 | (m = 0 | c[a + 56 >> 2])) <= 0))) {
                            for (i = h = 0; c[b + (h << 2) >> 2] = c[e + (i << 2) >> 2], c[b + ((1 | h) << 2) >> 2] = c[f + (i << 2) >> 2], c[b + ((2 | h) << 2) >> 2] = c[g + (i << 2) >> 2], (0 | (i = i + 1 | 0)) != (0 | m);) h = h + 4 | 0;
                            for (i = 0 | c[a + 160 >> 2], h = 0 | c[j >> 2], g = 0 | c[k >> 2], b = 0 | c[l >> 2], f = e = 0; c[i + (e << 2) >> 2] = c[h + (f << 2) >> 2], c[i + ((1 | e) << 2) >> 2] = c[g + (f << 2) >> 2], c[i + ((2 | e) << 2) >> 2] = c[b + (f << 2) >> 2], (0 | (f = f + 1 | 0)) != (0 | m);) e = e + 4 | 0
                        }
                    }

                    function ua(a) {
                        var j, k, l, m, b = 0, e = 0, f = 0, g = 0, h = 0, i = 0, e = 172 + (a |= 0) | 0, b = a + 264 | 0;
                        if (xa(e, 0 | c[a + 196 >> 2], 0 | c[a + 268 >> 2], 0 | c[b >> 2]), xa(e, 0 | c[a + 200 >> 2], 0 | c[a + 284 >> 2], 0 | c[b >> 2]), xa(e, 0 | c[a + 204 >> 2], 0 | c[a + 276 >> 2], 0 | c[b >> 2]), xa(e, 0 | c[a + 208 >> 2], 0 | c[a + 280 >> 2], 0 | c[b >> 2]), xa(e, 0 | c[a + 212 >> 2], 0 | c[a + 272 >> 2], 0 | c[b >> 2]), !((0 | d[4 + (0 | c[a >> 2]) >> 0]) < 4 || (xa(e, 0 | c[a + 216 >> 2], 0 | c[(m = a + 240 | 0) >> 2], 0 | c[b >> 2]), xa(e, 0 | c[a + 220 >> 2], 0 | c[(f = a + 244 | 0) >> 2], 0 | c[b >> 2]), xa(e, 0 | c[a + 224 >> 2], 0 | c[(g = a + 248 | 0) >> 2], 0 | c[b >> 2]), xa(e, 0 | c[a + 228 >> 2], 0 | c[(j = a + 252 | 0) >> 2], 0 | c[b >> 2]), xa(e, 0 | c[a + 232 >> 2], 0 | c[(k = a + 256 | 0) >> 2], 0 | c[b >> 2]), xa(e, 0 | c[a + 236 >> 2], 0 | c[(l = a + 260 | 0) >> 2], 0 | c[b >> 2]), b = 0 | c[a + 296 >> 2], e = 0 | c[m >> 2], f = 0 | c[f >> 2], g = 0 | c[g >> 2], (0 | (m = 0 | c[a + 164 >> 2])) <= 0))) {
                            for (i = h = 0; c[b + (h << 2) >> 2] = c[e + (i << 2) >> 2], c[b + ((1 | h) << 2) >> 2] = c[f + (i << 2) >> 2], c[b + ((2 | h) << 2) >> 2] = c[g + (i << 2) >> 2], (0 | (i = i + 1 | 0)) != (0 | m);) h = h + 4 | 0;
                            for (i = 0 | c[a + 300 >> 2], h = 0 | c[j >> 2], g = 0 | c[k >> 2], b = 0 | c[l >> 2], f = e = 0; c[i + (e << 2) >> 2] = c[h + (f << 2) >> 2], c[i + ((1 | e) << 2) >> 2] = c[g + (f << 2) >> 2], c[i + ((2 | e) << 2) >> 2] = c[b + (f << 2) >> 2], (0 | (f = f + 1 | 0)) != (0 | m);) e = e + 4 | 0
                        }
                    }

                    function va(a) {
                        var j, k, l, m, b = 0, e = 0, f = 0, g = 0, h = 0, i = 0, e = 340 + (a |= 0) | 0, b = a + 424 | 0;
                        if (xa(e, 0 | c[a + 364 >> 2], 0 | c[a + 448 >> 2], 0 | c[b >> 2]), ya(e, 0 | c[a + 368 >> 2], 0 | c[a + 440 >> 2], 0 | c[b >> 2]), za(e, 0 | c[a + 372 >> 2], 0 | c[a + 444 >> 2], 0 | c[892 + (0 | c[a >> 2]) >> 2], 2, 0 | c[b >> 2]), !((0 | d[4 + (0 | c[a >> 2]) >> 0]) < 4 || (xa(e, 0 | c[a + 376 >> 2], 0 | c[(m = a + 400 | 0) >> 2], 0 | c[b >> 2]), xa(e, 0 | c[a + 380 >> 2], 0 | c[(f = a + 404 | 0) >> 2], 0 | c[b >> 2]), xa(e, 0 | c[a + 384 >> 2], 0 | c[(g = a + 408 | 0) >> 2], 0 | c[b >> 2]), xa(e, 0 | c[a + 388 >> 2], 0 | c[(j = a + 412 | 0) >> 2], 0 | c[b >> 2]), xa(e, 0 | c[a + 392 >> 2], 0 | c[(k = a + 416 | 0) >> 2], 0 | c[b >> 2]), xa(e, 0 | c[a + 396 >> 2], 0 | c[(l = a + 420 | 0) >> 2], 0 | c[b >> 2]), b = 0 | c[a + 452 >> 2], e = 0 | c[m >> 2], f = 0 | c[f >> 2], g = 0 | c[g >> 2], (0 | (m = 0 | c[a + 332 >> 2])) <= 0))) {
                            for (i = h = 0; c[b + (h << 2) >> 2] = c[e + (i << 2) >> 2], c[b + ((1 | h) << 2) >> 2] = c[f + (i << 2) >> 2], c[b + ((2 | h) << 2) >> 2] = c[g + (i << 2) >> 2], (0 | (i = i + 1 | 0)) != (0 | m);) h = h + 4 | 0;
                            for (i = 0 | c[a + 456 >> 2], h = 0 | c[j >> 2], g = 0 | c[k >> 2], b = 0 | c[l >> 2], f = e = 0; c[i + (e << 2) >> 2] = c[h + (f << 2) >> 2], c[i + ((1 | e) << 2) >> 2] = c[g + (f << 2) >> 2], c[i + ((2 | e) << 2) >> 2] = c[b + (f << 2) >> 2], (0 | (f = f + 1 | 0)) != (0 | m);) e = e + 4 | 0
                        }
                    }

                    function xa(a, b, d, e) {
                        b |= 0, d |= 0, e |= 0;
                        var m, n, o, g = 0, h = 0, i = 0, j = 0, k = 0, l = 0;
                        if (0 < (0 | (g = 0 | c[8 + (a |= 0) >> 2]))) for (h = 0 | c[a + 20 >> 2], i = 0 | c[a + 12 >> 2], j = 0; f[i + (j << 2) >> 2] = +f[b + (j << 2) >> 2] * +f[h + (j << 2) >> 2], (0 | (j = j + 1 | 0)) != (0 | g);) ;
                    ...
                    function ya(a, b, d, e) {
                        b |= 0, d |= 0, e |= 0;
                        var m, n, g = 0, h = 0, i = 0, j = 0, k = 0, l = 0;
                        if (0 < (0 | (g = 0 | c[8 + (a |= 0) >> 2]))) for (h = 0 | c[a + 20 >> 2], i = 0 | c[a + 12 >> 2], j = 0; f[i + (j << 2) >> 2] = +f[b + (j << 2) >> 2] * +f[h + (j << 2) >> 2], (0 | (j = j + 1 | 0)) != (0 | g);) ;
                    ...
                    function za(a, b, d, e, g, h) {
                        b |= 0, d |= 0, e |= 0, g |= 0, h |= 0;
                        var r, s, u, w, x, i = 0, j = 0, k = 0, l = 0, m = 0, n = 0, o = 0, p = 0, q = 0,
                            t = 0 | c[(a |= 0) >> 2];
                        if (!((0 | t) <= 0)) if (w = a + 16 | 0, u = 0 | c[a + 4 >> 2], s = a + 20 | 0, r = g << 2, h) for (p = o = 0; ;) {
                            if (0 | c[h >> 2] && (l = 0 | c[d + (p << 2) >> 2], a = 0 | c[e + (p << 2) >> 2], n = 0 | v(a, g), m = (i = 0 | c[(0 | c[w >> 2]) + (p << 2) >> 2]) + o | 0, (k = 0 < (0 | n)) && Vc(0 | l, 0, 0 | v(r, a)), 0 < (0 | i) && (q = 0 | c[s >> 2], k))) {
                                i = o;
                                do {
                            ...
                            if (k = 0 | c[d + (o << 2) >> 2], a = 0 | c[e + (o << 2) >> 2], m = 0 | v(a, g), l = (h = 0 | c[(0 | c[w >> 2]) + (o << 2) >> 2]) + n | 0, (i = 0 < (0 | m)) && Vc(0 | k, 0, 0 | v(r, a)), 0 < (0 | h) && (p = 0 | c[s >> 2], i)) {
                                h = n;
                                do {
                    ...
                    function Ha(a) {
                        var b = 0, d = S;
                        return S = S + 16 | 0, b = d, (a |= 0) ? (b = 0 | function (a) {
                            a |= 0;
                            var b, e, d = S;
                            return S = S + 560 | 0, b = (e = d) + 548 | 0, Vc(0 | e, 0, 548), ma(a, e, b), S = d, 0 | c[b >> 2]
                        }(a), S = d, 0 | b) : (c[b >> 2] = 1515, c[b + 4 >> 2] = 1533, ia(0, 1269, b), S = d, (b = 0) | b)
                    }

                    function Ia(a, b, d) {
                        b |= 0, d |= 0;
                        var e, g, f = 0, h = 0, i = S;
                        return S = S + 32 | 0, h = i + 24 | 0, g = i + 16 | 0, f = i + 8 | 0, e = i, (a |= 0) ? b ? ((f = b) + 15 & -16 | 0) != (0 | f) ? (c[g >> 2] = 1551, c[4 + g >> 2] = 1342, ia(0, 1269, g), S = i, (h = 0) | h) : (b = 0 | na(a, b, d)) ? (S = i, 0 | b) : (c[h >> 2] = 1551, c[h + 4 >> 2] = 1577, ia(0, 1269, h), S = i, (h = 0) | h) : (c[f >> 2] = 1551, c[f + 4 >> 2] = 1303, ia(0, 1269, f), S = i, (h = 0) | h) : (c[e >> 2] = 1551, c[e + 4 >> 2] = 1533, ia(0, 1269, e), S = i, (h = 0) | h)
                    }

                    function ob(a, b, c, d) {
                        if (c = +c, d = +d, (b = +u(b = +b, a = +a) - +u(+d, +c)) < -3.1415927410125732) for (; (b += 6.2831854820251465) < -3.1415927410125732;) ;
                        if (3.1415927410125732 < b) for (; 3.1415927410125732 < (b += -6.2831854820251465);) ;
                        return +b
                    }

                    function pb(b, c) {
                        var d;
                        if (!((c = (b |= 0) + (c |= 0) + -1 | 0) >>> 0 <= b >>> 0)) for (; d = 0 | a[b >> 0], a[b >> 0] = 0 | a[c >> 0], b = b + 1 | 0, a[c >> 0] = d, b >>> 0 < (c = c + -1 | 0) >>> 0;) ;
                    }
                    ...
                    function xb(a) {
                        var s, l, o, b = 0, e = 0, g = 0, h = 0, i = 0, j = 0, k = 0, n = 0, p = 0, q = 0, r = 0, t = 0,
                            u = 0, v = 0,
                            m = (b = 0 | c[(l = 336 + (a |= 0) | 0) >> 2]) + (20 * (n = 0 | c[(o = a + 332 | 0) >> 2]) | 0) | 0,
                            p = a + 424 | 0, i = 0 | c[a + 48 >> 2], j = 0 | c[a + 316 >> 2], k = 0 | c[a + 308 >> 2];
                        if (0 < (0 | n)) for (n = 0 | c[p >> 2], g = 0 | c[a + 448 >> 2], h = 0 | c[a + 444 >> 2]; 0 | c[n >> 2] && (-1 != (0 | (e = 0 | c[b + 4 >> 2])) && (f[g >> 2] = +f[i + (e << 2) >> 2] * +f[g >> 2]), -1 != (0 | (e = 0 | c[b + 8 >> 2])) && (f[g >> 2] = +f[j + (e << 2) >> 2] * +f[g >> 2], r = 0 | c[h >> 2], $[3 & c[k + (e << 5) + 24 >> 2]](a, e, r, r, 0 | c[b + 16 >> 2]))), !(m >>> 0 <= (b = b + 20 | 0) >>> 0);) n = n + 4 | 0, g = g + 4 | 0, h = h + 4 | 0;
                        if (!((0 | d[4 + (0 | c[a >> 2]) >> 0]) < 4 || (k = (b = 0 | c[l >> 2]) + (20 * (r = 0 | c[o >> 2]) | 0) | 0, i = 0 | c[a + 324 >> 2], j = 0 | c[a + 328 >> 2], (0 | r) <= 0))) for (h = 0 | c[p >> 2], e = b, g = 0 | c[a + 452 >> 2], b = 0 | c[a + 456 >> 2]; 0 | c[h >> 2] && -1 != (0 | (q = 0 | c[e + 8 >> 2])) && (t = +f[g >> 2] * +f[(o = i + ((p = q << 2) << 2) | 0) >> 2], f[g >> 2] = t, u = +f[(r = g + 4 | 0) >> 2] * +f[4 + o >> 2], f[r >> 2] = u, v = +f[(a = g + 8 | 0) >> 2] * +f[8 + o >> 2], f[g >> 2] = t < 0 ? 0 : 1 < t ? 1 : t, f[r >> 2] = u < 0 ? 0 : 1 < u ? 1 : u, f[a >> 2] = v < 0 ? 0 : 1 < v ? 1 : v, f[g + 12 >> 2] = 1, v = +f[b >> 2], u = +f[(p = j + (p << 2) | 0) >> 2], f[b >> 2] = u = v + u - v * u, v = +f[(a = b + 4 | 0) >> 2], t = +f[p + 4 >> 2], f[a >> 2] = t = v + t - v * t, s = (v = +f[(r = b + 8 | 0) >> 2]) + (s = +f[p + 8 >> 2]) - v * s, f[b >> 2] = u < 0 ? 0 : 1 < u ? 1 : u, f[a >> 2] = t < 0 ? 0 : 1 < t ? 1 : t, f[r >> 2] = s < 0 ? 0 : 1 < s ? 1 : s, f[b + 12 >> 2] = 1), !(k >>> 0 <= (e = e + 20 | 0) >>> 0);) h = h + 4 | 0, g = g + 16 | 0, b = b + 16 | 0
                    }

                    function yb(a) {
                        var e, b = 0 | c[332 + (a |= 0) >> 2];
                        0 | c[a + 428 >> 2] && (Uc(0 | c[a + 460 >> 2], 0 | c[a + 436 >> 2], 0 | (e = b << 2)), Uc(0 | c[a + 464 >> 2], 0 | c[a + 440 >> 2], 0 | e), Uc(0 | c[a + 468 >> 2], 0 | c[a + 448 >> 2], 0 | e), (0 | d[4 + (0 | c[a >> 2]) >> 0]) <= 3 || (Uc(0 | c[a + 472 >> 2], 0 | c[a + 452 >> 2], 0 | (e = b << 4)), Uc(0 | c[a + 476 >> 2], 0 | c[a + 456 >> 2], 0 | e)))
                    }

                    function zb(b) {
                        var j, k, m, n, o, p, q, r, s, t, y, d = 0, e = 0, g = 0, h = 0, i = 0, l = 0, u = 0, v = 0, x = 0,
                            e = 0 | a[4 + (0 | c[(b |= 0) >> 2]) >> 0], w = 0 | c[b + 332 >> 2], d = b + 428 | 0;
                        if (0 | c[b + 620 >> 2]) {
                    ...
                    function Bb(a) {
                        var C, D, E, F, G, A, B, b = 0, e = 0, f = 0, g = 0, h = 0, i = 0, j = 0, k = 0, l = 0, m = 0,
                            n = 0, o = 0, p = 0, q = 0, r = 0, s = 0, t = 0, u = 0, v = 0, w = 0, x = 0, y = 0, z = 0,
                            H = 0, I = 0, J = 0, K = 0, k = 0 | c[(A = 60 + (a |= 0) | 0) >> 2], b = 0 | c[a >> 2],
                            l = 0 | c[b + 784 >> 2], m = 0 | c[(B = a + 56 | 0) >> 2], n = 0 | c[b + 1028 >> 2];
                        if (0 < (0 | m)) {
                            for (s = a + 80 | 0, v = a + 92 | 0, u = a + 88 | 0, w = a + 84 | 0, t = b + 984 | 0, h = b + 980 | 0, j = i = 0; ;) {
                                if (g = 0 | c[k + (24 * i | 0) >> 2], 15 == (0 | (z = 0 != (0 | c[(b = g + 24 | 0) >> 2]) || 0 | c[g + 28 >> 2] ? 15 : z)) && (c[((z = 0) | c[s >> 2]) + (i << 2) >> 2] = c[(r = g + 12 | 0) >> 2], 0 | c[b >> 2]) && (o = 0 | c[l + (i << 2) >> 2], x = (p = 0 | c[g + 16 >> 2]) + ((H = 0 | c[r >> 2]) << 2) | 0, 0 < (0 | H))) for (b = p, e = (0 | c[u >> 2]) + (j << 2) | 0, f = (0 | c[v >> 2]) + (j << 2) | 0; H = (0 | c[b >> 2]) + o | 0, c[f >> 2] = n + (c[(0 | c[t >> 2]) + (H << 2) >> 2] << 2), c[e >> 2] = c[(0 | c[h >> 2]) + (H << 2) >> 2], !(x >>> 0 <= (b = b + 4 | 0) >>> 0);) e = e + 4 | 0, f = f + 4 | 0;
                                if (0 | c[g + 28 >> 2] && (y = (q = 0 | c[g + 20 >> 2]) + ((H = 0 | c[g + 12 >> 2]) << 2) | 0, 0 < (0 | H))) for (b = (0 | c[w >> 2]) + (j << 2) | 0, e = q; c[b >> 2] = c[e >> 2], !(y >>> 0 <= (e = e + 4 | 0) >>> 0);) b = b + 4 | 0;
                        ...
                        if (!((0 | d[b + 4 >> 0]) < 4 || (G = 0 | c[A >> 2], H = 0 | c[b + 792 >> 2], (0 | (A = 0 | c[B >> 2])) <= 0))) for (D = a + 96 | 0, C = a + 100 | 0, B = a + 104 | 0, F = a + 108 | 0, E = a + 112 | 0, z = a + 116 | 0, x = b + 1228 | 0, v = b + 1232 | 0, u = b + 1236 | 0, y = b + 1240 | 0, w = b + 1244 | 0, k = b + 1248 | 0, m = l = 0; ;) {
                            if (b = 0 | c[G + (24 * l | 0) >> 2], 0 | c[b + 24 >> 2] && (I = 0 | c[H + (l << 2) >> 2], K = (J = 0 | c[b + 16 >> 2]) + ((a = 0 | c[b + 12 >> 2]) << 2) | 0, 0 < (0 | a))) for (e = 0 | c[x >> 2], f = 0 | c[v >> 2], g = 0 | c[u >> 2], h = 0 | c[y >> 2], i = 0 | c[w >> 2], j = 0 | c[k >> 2], n = J, o = (0 | c[B >> 2]) + (m << 2) | 0, p = (0 | c[C >> 2]) + (m << 2) | 0, q = (0 | c[D >> 2]) + (m << 2) | 0, r = (0 | c[z >> 2]) + (m << 2) | 0, s = (0 | c[E >> 2]) + (m << 2) | 0, t = (0 | c[F >> 2]) + (m << 2) | 0; a = (0 | c[n >> 2]) + I | 0, c[q >> 2] = c[e + (a << 2) >> 2], c[p >> 2] = c[f + (a << 2) >> 2], c[o >> 2] = c[g + (a << 2) >> 2], c[t >> 2] = c[h + (a << 2) >> 2], c[s >> 2] = c[i + (a << 2) >> 2], c[r >> 2] = c[j + (a << 2) >> 2], !(K >>> 0 <= (n = n + 4 | 0) >>> 0);) o = o + 4 | 0, p = p + 4 | 0, q = q + 4 | 0, r = r + 4 | 0, s = s + 4 | 0, t = t + 4 | 0;
                    ...
                    function Cb(a) {
                        var H, I, J, K, L, Q, b = 0, e = 0, f = 0, g = 0, h = 0, i = 0, j = 0, k = 0, l = 0, m = 0, n = 0,
                            o = 0, p = 0, q = 0, r = 0, s = 0, t = 0, u = 0, v = 0, w = 0, x = 0, y = 0, z = 0, A = 0,
                            B = 0, C = 0, D = 0, E = 0, F = 0, G = 0, M = 0, N = 0, O = 0, P = 0, T = 0, U = 0, V = 0,
                            W = 0, S = 0 | c[168 + (a |= 0) >> 2], R = 0 | c[a >> 2], r = 0 | c[816 + R >> 2];
                        if (0 < (0 | (s = 0 | c[(Q = a + 164 | 0) >> 2]))) for (A = a + 188 | 0, w = a + 200 | 0, E = a + 204 | 0, G = a + 208 | 0, K = a + 212 | 0, B = a + 196 | 0, L = a + 192 | 0, v = 992 + R | 0, D = 996 + R | 0, F = 1e3 + R | 0, J = 1004 + R | 0, C = 988 + R | 0, H = 1008 + R | 0, x = a + 288 | 0, I = 1012 + R | 0, y = a + 292 | 0, O = N = 0; ;) {
                            if (t = 0 | c[S + (12 * N | 0) >> 2], 14 == (0 | (P = 0 != (0 | c[(b = t + 24 | 0) >> 2]) || 0 | c[t + 28 >> 2] ? 14 : P)) && (c[((P = 0) | c[A >> 2]) + (N << 2) >> 2] = c[(z = t + 12 | 0) >> 2], 0 | c[b >> 2])) {
                                if (b = 0 | c[r + (N << 2) >> 2], k = (e = 0 | c[t + 16 >> 2]) + ((q = 0 | c[z >> 2]) << 2) | 0, 0 < (0 | q)) for (f = 0 | c[v >> 2], g = 0 | c[D >> 2], h = 0 | c[F >> 2], i = 0 | c[J >> 2], j = 0 | c[C >> 2], l = (0 | c[w >> 2]) + (O << 2) | 0, m = e, n = (0 | c[B >> 2]) + (O << 2) | 0, o = (0 | c[E >> 2]) + (O << 2) | 0, p = (0 | c[G >> 2]) + (O << 2) | 0, q = (0 | c[K >> 2]) + (O << 2) | 0; W = (0 | c[m >> 2]) + b | 0, c[l >> 2] = c[f + (W << 2) >> 2], c[o >> 2] = c[g + (W << 2) >> 2], c[p >> 2] = c[h + (W << 2) >> 2], c[q >> 2] = c[i + (W << 2) >> 2], c[n >> 2] = c[j + (W << 2) >> 2], !(k >>> 0 <= (m = m + 4 | 0) >>> 0);) l = l + 4 | 0, n = n + 4 | 0, o = o + 4 | 0, p = p + 4 | 0, q = q + 4 | 0;
                                W = (0 | c[e >> 2]) + b | 0, c[(0 | c[x >> 2]) + (N << 2) >> 2] = c[(0 | c[H >> 2]) + (W << 2) >> 2], c[(0 | c[y >> 2]) + (N << 2) >> 2] = c[(0 | c[I >> 2]) + (W << 2) >> 2]
                            }
                            if (0 | c[t + 28 >> 2] && (M = (u = 0 | c[t + 20 >> 2]) + ((W = 0 | c[t + 12 >> 2]) << 2) | 0, 0 < (0 | W))) for (b = (0 | c[L >> 2]) + (O << 2) | 0, e = u; c[b >> 2] = c[e >> 2], !(M >>> 0 <= (e = e + 4 | 0) >>> 0);) b = b + 4 | 0;
                        ...
                        if (!((0 | d[4 + R >> 0]) < 4 || (G = 0 | c[824 + R >> 2], (0 | (A = 0 | c[Q >> 2])) <= 0))) for (D = a + 216 | 0, C = a + 220 | 0, B = a + 224 | 0, F = a + 228 | 0, E = a + 232 | 0, z = a + 236 | 0, x = 1228 + R | 0, v = 1232 + R | 0, u = 1236 + R | 0, y = 1240 + R | 0, w = 1244 + R | 0, k = 1248 + R | 0, m = l = 0; ;) {
                            if (j = 0 | c[S + (12 * l | 0) >> 2], 0 | c[j + 24 >> 2] && (U = 0 | c[G + (l << 2) >> 2], V = (T = 0 | c[j + 16 >> 2]) + ((W = 0 | c[j + 12 >> 2]) << 2) | 0, 0 < (0 | W))) for (b = 0 | c[x >> 2], e = 0 | c[v >> 2], f = 0 | c[u >> 2], g = 0 | c[y >> 2], h = 0 | c[w >> 2], i = 0 | c[k >> 2], n = T, o = (0 | c[B >> 2]) + (m << 2) | 0, p = (0 | c[C >> 2]) + (m << 2) | 0, q = (0 | c[D >> 2]) + (m << 2) | 0, r = (0 | c[z >> 2]) + (m << 2) | 0, s = (0 | c[E >> 2]) + (m << 2) | 0, t = (0 | c[F >> 2]) + (m << 2) | 0; W = (0 | c[n >> 2]) + U | 0, c[q >> 2] = c[b + (W << 2) >> 2], c[p >> 2] = c[e + (W << 2) >> 2], c[o >> 2] = c[f + (W << 2) >> 2], c[t >> 2] = c[g + (W << 2) >> 2], c[s >> 2] = c[h + (W << 2) >> 2], c[r >> 2] = c[i + (W << 2) >> 2], !(V >>> 0 <= (n = n + 4 | 0) >>> 0);) o = o + 4 | 0, p = p + 4 | 0, q = q + 4 | 0, r = r + 4 | 0, s = s + 4 | 0, t = t + 4 | 0;
                            if ((0 | (l = l + 1 | 0)) == (0 | A)) break;
                            m = (0 | c[j + 8 >> 2]) + m | 0
                        }
                    }
                    ...
                    function Db(a) {
                        var F, G, D, E, b = 0, e = 0, f = 0, g = 0, h = 0, i = 0, j = 0, k = 0, l = 0, m = 0, n = 0, o = 0,
                            p = 0, q = 0, r = 0, s = 0, t = 0, u = 0, v = 0, w = 0, x = 0, y = 0, z = 0, A = 0, B = 0,
                            C = 0, H = 0, I = 0, J = 0, K = 0, l = 0 | c[(D = 336 + (a |= 0) | 0) >> 2], b = 0 | c[a >> 2],
                            m = 0 | c[b + 856 >> 2], n = 0 | c[(E = a + 332 | 0) >> 2], o = 0 | c[b + 1028 >> 2];
                        if (0 < (0 | n)) {
                            for (t = a + 356 | 0, y = a + 372 | 0, w = a + 364 | 0, u = a + 368 | 0, z = a + 360 | 0, v = b + 1024 | 0, x = b + 1016 | 0, i = b + 1020 | 0, k = j = 0; ;) {
                                if (h = 0 | c[l + (20 * j | 0) >> 2], 15 == (0 | (C = 0 != (0 | c[(b = h + 24 | 0) >> 2]) || 0 | c[h + 28 >> 2] ? 15 : C)) && (c[((C = 0) | c[t >> 2]) + (j << 2) >> 2] = c[(s = h + 12 | 0) >> 2], 0 | c[b >> 2]) && (p = 0 | c[m + (j << 2) >> 2], A = (q = 0 | c[h + 16 >> 2]) + ((H = 0 | c[s >> 2]) << 2) | 0, 0 < (0 | H))) for (b = (0 | c[u >> 2]) + (k << 2) | 0, e = q, f = (0 | c[w >> 2]) + (k << 2) | 0, g = (0 | c[y >> 2]) + (k << 2) | 0; H = (0 | c[e >> 2]) + p | 0, c[g >> 2] = o + (c[(0 | c[v >> 2]) + (H << 2) >> 2] << 2), c[f >> 2] = c[(0 | c[x >> 2]) + (H << 2) >> 2], c[b >> 2] = c[(0 | c[i >> 2]) + (H << 2) >> 2], !(A >>> 0 <= (e = e + 4 | 0) >>> 0);) b = b + 4 | 0, f = f + 4 | 0, g = g + 4 | 0;
                                if (0 | c[h + 28 >> 2] && (B = (r = 0 | c[h + 20 >> 2]) + ((H = 0 | c[h + 12 >> 2]) << 2) | 0, 0 < (0 | H))) for (b = (0 | c[z >> 2]) + (k << 2) | 0, e = r; c[b >> 2] = c[e >> 2], !(B >>> 0 <= (e = e + 4 | 0) >>> 0);) b = b + 4 | 0;
                        ...
                        if (!((0 | d[b + 4 >> 0]) < 4 || (G = 0 | c[D >> 2], H = 0 | c[b + 864 >> 2], (0 | (A = 0 | c[E >> 2])) <= 0))) for (D = a + 376 | 0, C = a + 380 | 0, B = a + 384 | 0, F = a + 388 | 0, E = a + 392 | 0, z = a + 396 | 0, x = b + 1228 | 0, v = b + 1232 | 0, u = b + 1236 | 0, y = b + 1240 | 0, w = b + 1244 | 0, k = b + 1248 | 0, m = l = 0; ;) {
                            if (b = 0 | c[G + (20 * l | 0) >> 2], 0 | c[b + 24 >> 2] && (I = 0 | c[H + (l << 2) >> 2], K = (J = 0 | c[b + 16 >> 2]) + ((a = 0 | c[b + 12 >> 2]) << 2) | 0, 0 < (0 | a))) for (e = 0 | c[x >> 2], f = 0 | c[v >> 2], g = 0 | c[u >> 2], h = 0 | c[y >> 2], i = 0 | c[w >> 2], j = 0 | c[k >> 2], n = J, o = (0 | c[B >> 2]) + (m << 2) | 0, p = (0 | c[C >> 2]) + (m << 2) | 0, q = (0 | c[D >> 2]) + (m << 2) | 0, r = (0 | c[z >> 2]) + (m << 2) | 0, s = (0 | c[E >> 2]) + (m << 2) | 0, t = (0 | c[F >> 2]) + (m << 2) | 0; a = (0 | c[n >> 2]) + I | 0, c[q >> 2] = c[e + (a << 2) >> 2], c[p >> 2] = c[f + (a << 2) >> 2], c[o >> 2] = c[g + (a << 2) >> 2], c[t >> 2] = c[h + (a << 2) >> 2], c[s >> 2] = c[i + (a << 2) >> 2], c[r >> 2] = c[j + (a << 2) >> 2], !(K >>> 0 <= (n = n + 4 | 0) >>> 0);) o = o + 4 | 0, p = p + 4 | 0, q = q + 4 | 0, r = r + 4 | 0, s = s + 4 | 0, t = t + 4 | 0;
                            if ((0 | (l = l + 1 | 0)) == (0 | A)) break;
                            m = (0 | c[b + 8 >> 2]) + m | 0
                        }
                    }
                    ...
                    function Gb(a) {
                        var d, e, g, b = 0;
                        if (yb(a |= 0), function (a) {
                            var e, g, b = 0, d = 0, h = 0, j = 0, k = 0,
                                i = (b = 0 | c[(a |= 0) + 4 >> 2]) + (52 * (h = 0 | c[a >> 2]) | 0) | 0;
                            if (!((0 | h) <= 0)) for (h = 0 | c[a + 12 >> 2]; d = +f[h >> 2], a = b + 4 | 0, d = (g = 0 == (0 | c[b + 16 >> 2])) ? (k = +f[a >> 2], j = +f[b + 8 >> 2], d < k ? k : j < d ? j : d) : (k = +f[b + 12 >> 2], (j = +f[a >> 2]) + k * ((d = (d - j) / k) - (0 | ~~+q(+d)))), a = b + 48 | 0, +f[(e = b + 44 | 0) >> 2] != d ? (c[a >> 2] = 1, f[e >> 2] = d) : c[a >> 2] = 0, g && (f[h >> 2] = d), !(i >>> 0 <= (b = b + 52 | 0) >>> 0);) h = h + 4 | 0
                        }(a + 540 | 0), function (a) {
                            var n, b = 0, d = 0, e = 0, g = 0, h = 0, i = 0, j = 0, k = 0, l = 0, m = 0, o = 0, p = 0,
                                q = 0, r = 0, t = 0, u = 0,
                                s = (b = 0 | c[(a |= 0) + 544 >> 2]) + (52 * (n = 0 | c[a + 540 >> 2]) | 0) | 0;
                            if (!((0 | n) <= 0)) {
                                n = 0 == (0 | c[a + 620 >> 2]);
                                do {
                                    a:do {
                                        if (0 == (0 | c[b >> 2]) && (o = +f[b + 44 >> 2], p = +f[b + 20 >> 2], q = +f[b + 24 >> 2], t = (r = 0 | c[b + 28 >> 2]) + (28 * (l = 0 | c[b + 32 >> 2]) | 0) | 0, 0 < (0 | l))) {
                                            if (!n) for (l = r; ;) {
                                                h = 0 | c[l >> 2];
                                                do {
                                                    if (1 <= (0 | h)) {
                                                        if (g = 0 | c[l + 4 >> 2], d = (e = +f[g >> 2]) - p, 1 == (0 | h)) {
                                                        ...
                                                        if (o < p + e) d = a = h = 0, m = 41; else {
                                                            ...
                                                            d = d - p < o ? h = 0 : (a = a + -1 | 0, (d -= e) < q ? h = 0 : (h = 0, (o - e) / d)), m = 41
                                                        }
                                                    } else d = a = h = 0, m = 41
                                                } while (0);
                                                if (41 == (0 | m) && (h | (m = 0) == (0 | c[(g = l + 16 | 0) >> 2]) ? (i = 1 & h, m = 43) : (c[l + 24 >> 2] = 1, c[l + 20 >> 2] = 1, k = l + 8 | 0, j = l + 12 | 0, h = 0)), 43 == (0 | m) && (e = +f[(j = l + 12 | (m = 0)) >> 2], h = 1 & ((0 | c[(k = l + 8 | 0) >> 2]) != (0 | a) | (u = e != d) & (0 == d | 0 == e)), c[l + 24 >> 2] = 1 & u, c[l + 20 >> 2] = h, h = i), f[j >> 2] = d, c[k >> 2] = a, c[g >> 2] = h, t >>> 0 <= (l = l + 28 | 0) >>> 0) break a
                                            }
                                                ...
                                                do {
                                                    if (1 <= (0 | h)) {
                                                        ...
                                                        if (o < p + e) d = a = h = 0, m = 24; else {
                                                            ...
                                                            d = d - p < o ? h = 0 : (a = a + -1 | 0, (d -= e) < q ? h = 0 : (h = 0, (o - e) / d)), m = 24
                                                        }
                                                    } else d = a = h = 0, m = 24
                                                } while (0)
                                            } while (24 == (0 | m) && (h | (m = 0) == (0 | c[(g = l + 16 | 0) >> 2]) ? (i = 1 & h, m = 26) : (c[l + 24 >> 2] = 1, c[l + 20 >> 2] = 1, k = l + 8 | 0, j = l + 12 | 0, h = 0)), 26 == (0 | m) && (e = +f[(j = l + 12 | (m = 0)) >> 2], h = 1 & ((0 | c[(k = l + 8 | 0) >> 2]) != (0 | a) | (u = e != d) & (0 == d | 0 == e)), c[l + 24 >> 2] = 1 & u, c[l + 20 >> 2] = h, h = i), f[j >> 2] = d, c[k >> 2] = a, c[g >> 2] = h, (l = l + 28 | 0) >>> 0 < t >>> 0)
                                        }
                                    } while (0)
                                } while ((b = b + 52 | 0) >>> 0 < s >>> 0)
                            }
                        }(a), Nb(a), function (a) {
                            var l, o, y, z, p, b = 0, d = 0, e = 0, g = 0, h = 0, i = 0, j = 0, k = 0, m = 0, n = 0, q = 0,
                                r = 0, s = 0, u = 0, w = 0, x = 0,
                                t = (b = 0 | c[(a |= 0) + 568 >> 2]) + (36 * (p = 0 | c[a + 564 >> 2]) | 0) | 0;
                            if (!((0 | p) <= 0)) {
                                p = 0 == (0 | c[a + 620 >> 2]);
                                do {
                                    o = 0 | c[b + 4 >> 2];
                                    ...
                                    b:do {
                                        if (11 == (0 | x)) if (d = p ? a : 1, (x = 0) != ((a = p ? e : 1) | d | 0) && (c[b + 12 >> 2] = w = 1 << i, q = 0 | c[b >> 2], r = 0 | c[b + 16 >> 2], s = 0 | c[b + 20 >> 2], u = r + (w << 2) | 0, 31 != (0 | i))) {
                                            for (Vc(0 | r, 0, ((e = r + 4 | 0) >>> 0 < u >>> 0 ? u : e) + ~r + 4 & -4 | 0), e = s + (w << 2) | 0, g = s; f[g >> 2] = 1, (g = g + 4 | 0) >>> 0 < e >>> 0;) ;
                                            if (1 <= (0 | o)) {
                                                if (!i) for (i = 0, k = 1; ;) {
                                                ...
                                                do {
                                                    if (l = 0 | c[q + (m << 2) >> 2], g = 0 | c[8 + l >> 2], k = 0 | v(g, n), 0 == (h = +f[(j = 12 + l | 0) >> 2])) for (g = 0; c[(j = r + (g << 2) | 0) >> 2] = (0 | c[j >> 2]) + k, (0 | (g = g + 1 | 0)) != (0 | w);) ; else {
                                                        for (i = 0 | v(g + 1 | 0, n), c[r >> 2] = (0 | c[r >> 2]) + k, f[s >> 2] = (1 - h) * +f[s >> 2], g = 1; h = +f[j >> 2], c[(y = r + (g << 2) | 0) >> 2] = ((z = 0 != (g & e | 0)) ? i : k) + (0 | c[y >> 2]), f[(y = s + (g << 2) | 0) >> 2] = (z ? h : 1 - h) * +f[y >> 2], (0 | (g = g + 1 | 0)) != (0 | w);) ;
                                                        e <<= 1
                                                    }
                        ...
                        }(a), Ob(a), e = 0 | c[a + 4 >> 2], d = (b = 0 | c[a + 52 >> 2]) + (e << 2) | 0, 0 < (0 | e)) for (; g = +f[b >> 2], f[b >> 2] = g < 0 ? 0 : 1 < g ? 1 : g, (b = b + 4 | 0) >>> 0 < d >>> 0;) ;
                        !function (a, b, d) {
                            d |= 0;
                            var e = 0, f = (b |= 0) + (12 * (a |= 0) | 0) | 0;
                            if (!((0 | a) <= 0)) for (e = d; ;) {
                                do {
                                    if (0 | c[b + 8 >> 2]) {
                            ...
                            var e, f, i, q, r, b = 0, d = 0, g = 0, h = 0, k = 0, l = 0, o = 0, p = 0, s = 0, t = 0, u = 0,
                                j = 0 | c[8 + (a |= 0) >> 2], b = 0 | c[a >> 2], m = 0 | c[b + 724 >> 2],
                                n = 0 | c[a + 4 >> 2];
                            if (!((0 | n) <= 0)) for (q = a + 28 | 0, r = a + 36 | 0, i = a + 32 | 0, f = b + 976 | 0, h = g = 0; ;) {
                                if (e = 0 | c[j + (12 * g | 0) >> 2], 6 == (0 | (u = 0 != (0 | c[(a = 24 + e | 0) >> 2]) || 0 | c[28 + e >> 2] ? 6 : u)) && (c[((u = 0) | c[q >> 2]) + (g << 2) >> 2] = c[(p = 12 + e | 0) >> 2], 0 | c[a >> 2]) && (o = 0 | c[m + (g << 2) >> 2], s = (k = 0 | c[16 + e >> 2]) + ((d = 0 | c[p >> 2]) << 2) | 0, 0 < (0 | d))) for (a = 0 | c[f >> 2], b = (0 | c[r >> 2]) + (h << 2) | 0, d = k; c[b >> 2] = c[a + ((0 | c[d >> 2]) + o << 2) >> 2], !(s >>> 0 <= (d = d + 4 | 0) >>> 0);) b = b + 4 | 0;
                                if (0 | c[28 + e >> 2] && (t = (l = 0 | c[20 + e >> 2]) + ((d = 0 | c[12 + e >> 2]) << 2) | 0, 0 < (0 | d))) for (a = (0 | c[i >> 2]) + (h << 2) | 0, b = l; c[a >> 2] = c[b >> 2], !(t >>> 0 <= (b = b + 4 | 0) >>> 0);) a = a + 4 | 0;
                                if ((0 | (g = g + 1 | 0)) == (0 | n)) break;
                                h = (0 | c[8 + e >> 2]) + h | 0
                            }
                        }(a), function (a) {
                            ya(12 + (a |= 0) | 0, 0 | c[36 + a >> 2], 0 | c[44 + a >> 2], 0 | c[40 + a >> 2])
                        }(a), function (a) {
                            var d, f, g, h, i, j, k, b = 0, e = 0;
                            if (S = (k = S) + 16 | 0, j = k, i = (b = 0 | c[308 + (a |= 0) >> 2]) + ((e = 0 | c[a + 304 >> 2]) << 5) | 0, f = 0 | c[a + 40 >> 2], g = 0 | c[a + 312 >> 2], h = 0 | c[a + 144 >> 2], d = 0 | c[a + 264 >> 2], (0 | e) <= 0) S = k; else {
                                for (e = g; ;) {
                                    do {
                                        if (0 | c[b + 28 >> 2]) {
                        ...
                        }(a), Bb(a), Cb(a), ta(a), ua(a), function (a) {
                            var b = 0, d = 0,
                                g = (b = 0 | c[(a |= 0) + 336 >> 2]) + (20 * (d = 0 | c[a + 332 >> 2]) | 0) | 0,
                                e = 0 | c[a + 40 >> 2], f = 0 | c[a + 312 >> 2];
                            if (!((0 | d) <= 0)) for (d = 0 | c[a + 424 >> 2]; ;) {
                                do {
                                    if (0 | c[b + 12 >> 2]) {
                        ...
                        }(a), Db(a), va(a), function (a) {
                            var e, f, i, q, r, b = 0, d = 0, g = 0, h = 0, k = 0, l = 0, o = 0, p = 0, s = 0, t = 0, u = 0,
                                j = 0 | c[504 + (a |= 0) >> 2], b = 0 | c[a >> 2], m = 0 | c[b + 1192 >> 2],
                                n = 0 | c[a + 500 >> 2];
                            if (!((0 | n) <= 0)) for (q = a + 524 | 0, r = a + 532 | 0, i = a + 528 | 0, f = b + 1224 | 0, h = g = 0; ;) {
                                if (e = 0 | c[j + (24 * g | 0) >> 2], 6 == (0 | (u = 0 != (0 | c[(a = 24 + e | 0) >> 2]) || 0 | c[28 + e >> 2] ? 6 : u)) && (c[((u = 0) | c[q >> 2]) + (g << 2) >> 2] = c[(p = 12 + e | 0) >> 2], 0 | c[a >> 2]) && (o = 0 | c[m + (g << 2) >> 2], s = (k = 0 | c[16 + e >> 2]) + ((d = 0 | c[p >> 2]) << 2) | 0, 0 < (0 | d))) for (a = 0 | c[f >> 2], b = (0 | c[r >> 2]) + (h << 2) | 0, d = k; c[b >> 2] = c[a + ((0 | c[d >> 2]) + o << 2) >> 2], !(s >>> 0 <= (d = d + 4 | 0) >>> 0);) b = b + 4 | 0;
                                if (0 | c[28 + e >> 2] && (t = (l = 0 | c[20 + e >> 2]) + ((d = 0 | c[12 + e >> 2]) << 2) | 0, 0 < (0 | d))) for (a = (0 | c[i >> 2]) + (h << 2) | 0, b = l; c[a >> 2] = c[b >> 2], !(t >>> 0 <= (b = b + 4 | 0) >>> 0);) a = a + 4 | 0;
                                if ((0 | (g = g + 1 | 0)) == (0 | n)) break;
                                h = (0 | c[8 + e >> 2]) + h | 0
                            }
                            ...
                            var b = 0, d = 0, g = 0, h = 0, j = 0,
                                i = (b = 0 | c[8 + (a |= 0) >> 2]) + (12 * (j = 0 | c[a + 4 >> 2]) | 0) | 0,
                                e = 0 | c[a + 48 >> 2];
                            if (!((0 | j) <= 0)) for (j = 0 | c[a + 40 >> 2], d = e, a = 0 | c[a + 52 >> 2]; 0 | c[j >> 2] && (g = +f[a >> 2], f[d >> 2] = g, -1 != (0 | (h = 0 | c[b + 4 >> 2]))) && (f[d >> 2] = g * +f[e + (h << 2) >> 2]), !(i >>> 0 <= (b = b + 12 | 0) >>> 0);) j = j + 4 | 0, d = d + 4 | 0, a = a + 4 | 0
                        }(a), function (a) {
                            var d = 0, e = 0, f = 0, b = 0 | c[304 + (a |= 0) >> 2];
                            if (!((0 | b) <= 0)) for (d = 0 | c[312 + a >> 2], e = 0 | c[308 + a >> 2], f = 0; 0 | c[d >> 2] && _[3 & c[e + 20 >> 2]](a, f), (0 | (f = f + 1 | 0)) != (0 | b);) d = d + 4 | 0, e = e + 32 | 0
                        }(a), xb(a), ea(a), function (a) {
                            var g, j, b = 0, d = 0, e = 0, h = 0, i = 0;
                            if (!(0 | c[(a |= 0) + 624 >> 2] || (g = (b = 0 | c[a + 336 >> 2]) + (20 * (h = 0 | c[a + 332 >> 2]) | 0) | 0, (0 | h) <= 0))) for (h = 0 | c[a + 424 >> 2], a = 0 | c[a + 444 >> 2]; ;) {
                                if (0 | c[h >> 2] && (e = 0 | c[a >> 2], i = (d = 0 | c[b + 16 >> 2]) << 1, 0 < (0 | d))) for (d = 1; f[(j = e + (d << 2) | 0) >> 2] = -+f[j >> 2], (0 | (d = d + 2 | 0)) < (0 | i);) ;
                                if (g >>> 0 <= (b = b + 20 | 0) >>> 0) break;
                                h = h + 4 | 0, a = a + 4 | 0
                            }
                        }(a), function (a) {
                            var n, r, b = 0, d = 0, e = 0, f = 0, g = 0, h = 0, i = 0, j = 0, k = 0, l = 0, m = 0, o = 0,
                                p = 0, q = 0 | c[(a |= 0) + 480 >> 2], j = (r = 0 | c[a + 484 >> 2]) + (28 * q | 0) | 0,
                                b = 0 | c[a + 440 >> 2], d = 0 | c[a + 44 >> 2], e = 0 | c[a + 40 >> 2],
                                f = 0 | c[a + 424 >> 2];
                            if (!((0 | q) <= 0)) {
                                k = r;
                                do {
                                ...
                                do {
                                    if (0 < (0 | c[(a = r + (28 * m | 0) + 24 | 0) >> 2])) {
                                        for (b = 0 | c[o >> 2], e = 0; c[b + (e << 2) >> 2] = -1, (0 | (e = e + 1 | 0)) < (0 | (d = 0 | c[a >> 2]));) ;
                                        if (0 < (0 | d)) for (b = 0 | c[l >> 2], d = 0; c[b + (d << 2) >> 2] = -1, (0 | (d = d + 1 | 0)) < (0 | c[a >> 2]);) ;
                                    }
                                    if (0 < (0 | c[(k = r + (28 * m | 0) + 4 | 0) >> 2])) {
                                        for (j = 0 | c[p >> 2], d = 0; c[j + (d << 2) >> 2] = -1, (0 | (d = d + 1 | 0)) < (0 | (b = 0 | c[k >> 2]));) ;
                                    ...
                                    if (0 < (0 | (b = 0 | c[a >> 2]))) {
                                        ...
                                        do {
                                            if (-1 != (0 | (e = 0 | c[i + (h << 2) >> 2]))) {
                                                for (f = 0 | c[j >> 2], g = 0 | c[p >> 2]; d = (b = 1 == (0 | c[f + (e << 4) >> 2]) ? (b = 0 | c[f + (e << 4) + 8 >> 2], c[r + (28 * b | 0) + 8 >> 2] = d, 0 | c[r + (28 * b | 0) >> 2]) : (c[n + (c[f + (e << 4) + 4 >> 2] << 2) >> 2] = d, 1)) + d | 0, !((0 | (e = 0 | c[g + ((k = e) << 2) >> 2])) <= (0 | k) | -1 == (0 | e));) ;
                                                b = 0 | c[a >> 2]
                                            }
                                        } while ((0 | (h = h + 1 | 0)) < (0 | b))
                                    }
                    ...
                    function Nb(a) {
                        var l, s, b = 0, e = 0, g = 0, h = 0, i = 0, j = 0, k = 0, m = 0, n = 0, o = 0, p = 0, q = 0, r = 0,
                            t = 0, u = 0;
                        if (!((0 | d[4 + (0 | c[(a |= 0) >> 2]) >> 0]) < 4 || (s = (b = 0 | c[a + 544 >> 2]) + (52 * (l = 0 | c[a + 540 >> 2]) | 0) | 0, (0 | l) <= 0))) {
                            l = 0 == (0 | c[a + 620 >> 2]);
                            do {
                                a:do {
                                    if (1 == (0 | c[b >> 2]) && (q = +f[b + 44 >> 2], t = (r = 0 | c[b + 36 >> 2]) + (28 * (k = 0 | c[b + 40 >> 2]) | 0) | 0, 0 < (0 | k))) {
                                        if (!l) for (j = r; ;) {
                                            g = 0 | c[j >> 2];
                                            do {
                    ...
                    function Ob(a) {
                        var q, r, s, t, b = 0, e = 0, g = 0, h = 0, i = 0, j = 0, k = 0, l = 0, m = 0, n = 0, o = 0, p = 0;
                        if (!((0 | d[4 + (0 | c[(a |= 0) >> 2]) >> 0]) < 4 || (t = (b = 0 | c[a + 592 >> 2]) + (48 * (s = 0 | c[a + 588 >> 2]) | 0) | 0, (0 | s) <= 0))) {
                            s = 0 == (0 | c[a + 620 >> 2]);
                            do {
                                if (a = 0 | c[b >> 2], g = s ? 0 | c[a + 24 >> 2] : 1, (l = s ? 0 | c[a + 20 >> 2] : 1) | g) {
                                    ...
                                    10 == (0 | j) && (j = 0, c[b + 8 >> 2] = a, g ? (i = k, a = l, j = 11) : (i = k, a = l, g = 0)), 11 == (0 | j) && (f[b + 20 >> 2] = 1 - e, f[b + 24 >> 2] = e), a ? (c[b + 12 >> 2] = i, c[b + 16 >> 2] = i + 1) : a = 0
                                } else a = l;
                                q = 0 | c[b + 36 >> 2];
                                a:do {
                                    if (0 < (0 | q)) {
                                        if (r = 0 | c[b + 40 >> 2], !s) for (p = 0, e = 1; ;) {
                                            o = 0 | c[r + (p << 2) >> 2], j = 0 | c[o + 4 >> 2], k = 0 | c[o + 8 >> 2], l = 0 | c[o + 12 >> 2], n = +f[44 + (0 | c[o >> 2]) >> 2];
                                            do {
                                                if (1 <= (0 | l)) {
                                                    if (1 == (0 | l)) {
                                                        h = +f[k >> 2];
                                                    ...
                                                    if (40 == (0 | j)) {
                                                        h = (1 - (h = (n - h) / (m - h))) * +f[k + (i + -1 << 2) >> 2] + h * +f[k + (i << 2) >> 2];
                                                        break
                                                    }
                                                    if (41 == (0 | j)) {
                                                        h = +f[k + (l + -1 << 2) >> 2];
                                            ...
                                            if (e = e < (f[o + 16 >> 2] = h) ? e : h, (0 | (p = p + 1 | 0)) == (0 | q)) break a
                                        }
                                        p = 0, e = 1;
                                        do {
                                            if (o = 0 | c[r + (p << 2) >> 2], i = 0 | c[o >> 2], 0 | c[i + 48 >> 2]) {
                                                j = 0 | c[o + 4 >> 2], k = 0 | c[o + 8 >> 2], l = 0 | c[o + 12 >> 2], n = +f[i + 44 >> 2];
                                                do {
                                                    if (1 <= (0 | l)) {
                                                        if (1 == (0 | l)) {
                                                            h = +f[k >> 2];
                            ...
                            } while (f[b + 44 >> 2] = e, c[b + 28 >> 2] = a, c[b + 32 >> 2] = g, (b = b + 48 | 0) >>> 0 < t >>> 0)
                        }
                    }
                    ...
                    function _b(b, d, e) {
                        b |= 0, d |= 0, e |= 0;
                        var f, i, j, h = 0, g = S;
                        S = S + 144 | 0, Uc(0 | (i = g), 640, 144), c[i + 48 >> 2] = h = (h = -2 - b | 0) >>> 0 < 256 ? h : 256, c[(f = i + 20 | 0) >> 2] = b, j = (c[i + 44 >> 2] = b) + h | 0, c[(b = i + 16 | 0) >> 2] = j, c[i + 28 >> 2] = j, $b(i, d, e), 0 | h && (j = 0 | c[f >> 2], a[j + (((0 | j) == (0 | c[b >> 2])) << 31 >> 31) >> 0] = 0), S = g
                    }
                    ...
                    function ac(b, e, f, g, h, i) {
                        ...
                        var C, B, j = 0, k = 0, l = 0, m = 0, n = 0, o = 0, p = 0, q = 0, r = 0, s = 0, t = 0, u = 0, w = 0,
                            x = 0, y = 0, A = 0, D = 0, E = 0, F = 0, G = 0, H = S;
                        S = S + 560 | 0, m = H + 32 | 0, E = 12 + (l = (F = G = H) + 540 | 0) | (c[(t = H + 536 | 0) >> 2] = 0), rc(e), B = (0 | (j = 0 | z())) < 0 ? (rc(e = -e), j = 0 | z(), D = 1, 2539) : (D = 0 != (2049 & h | 0) & 1, 0 == (2048 & h | 0) ? 0 == (1 & h | 0) ? 2540 : 2545 : 2542);
                        do {
                            if (!0 & 2146435072 == (2146435072 & j | 0)) G = 0 != (32 & i | 0), mc(b, 32, f, j = D + 3 | 0, -65537 & h), ec(b, B, D), ec(b, e != e | !1 ? G ? 2566 : 2570 : G ? 2558 : 2562, 3), mc(b, 32, f, j, 8192 ^ h); else {
                                if ((j = 0 != (q = 2 * +sc(e, t))) && (c[t >> 2] = (0 | c[t >> 2]) - 1), 97 == (0 | (w = 32 | i))) {
                                    r = 0 == (0 | (o = 32 & i)) ? B : 9 + B | 0, p = 2 | D, j = 12 - g | 0;
                                    do {
                                        if (!(11 < g >>> 0 | 0 == (0 | j))) {
                                    ...
                                    for ((0 | (j = 0 | kc(j = (0 | (k = 0 | c[t >> 2])) < 0 ? 0 - k | 0 : k, ((0 | j) < 0) << 31 >> 31, E))) == (0 | E) && (a[(j = l + 11 | 0) >> 0] = 48), a[j + -1 >> 0] = 43 + (k >> 31 & 2), a[(n = j + -2 | 0) >> 0] = i + 15, k = (0 | g) < 1, l = 0 == (8 & h | 0), j = G; m = j + 1 | 0, a[j >> 0] = o | d[480 + (D = ~~e) >> 0], e = 16 * (e - (0 | D)), 1 != (m - F | 0) || l & k & 0 == e || (a[m >> 0] = 46, m = j + 2 | 0), 0 != e;) j = m;
                                    mc(b, 32, f, E = (j = 0 != (0 | g) && (-2 - F + m | 0) < (0 | g) ? g + 2 + (k = E) - (l = n) | 0 : (k = E) - F - (l = n) + m | 0) + p | 0, h), ec(b, r, p), mc(b, 48, f, E, 65536 ^ h), ec(b, G, F = m - F | 0), mc(b, 48, j - (F + (G = k - l | 0)) | 0, 0, 0), ec(b, n, G), mc(b, 32, f, E, 8192 ^ h), j = E;
                                    break
                                }
                                ...
                                if (y = C, 0 < (0 | l)) {
                                    ...
                                    do {
                                        if (o = (0 | l) < 29 ? l : 29, j >>> 0 <= (l = m + -4 | 0) >>> 0) {
                                            for (n = 0; s = 0 | Mc(0 | (s = 0 | Sc(0 | c[l >> 2], 0, 0 | o)), 0 | z(), 0 | n, 0), x = 0 | Mc(0 | s, 0 | (u = 0 | z()), 0 | (x = 0 | Lc(0 | (n = 0 | Qc(0 | s, 0 | u, 1e9, 0)), 0 | z(), -1e9, -1)), 0 | z()), z(), c[l >> 2] = x, j >>> 0 <= (l = l + -4 | 0) >>> 0;) ;
                                            n && (c[(j = j + -4 | 0) >> 2] = n)
                                        }
                                        a:do {
                                            if (j >>> 0 < m >>> 0) for (; ;) {
                                ...
                                if (j >>> 0 < s >>> 0) {
                                    if (l = 9 * ((y - j | 0) >> 2) | 0, 10 <= (n = 0 | c[j >> 2]) >>> 0) for (m = 10; l = l + 1 | 0, (m = 10 * m | 0) >>> 0 <= n >>> 0;) ;
                                } else l = 0;
                                if ((0 | (m = k - (102 == (0 | w) ? 0 : l) + (((u = 0 != (0 | k)) & (t = 103 == (0 | w))) << 31 >> 31) | 0)) < ((9 * ((x = s - y | 0) >> 2) | 0) - 9 | 0)) {
                                    if (g = C + 4 + ((m = (0 | (x = m + 9216 | 0)) / 9 | 0) - 1024 << 2) | 0, (0 | (m = x + (0 | v(m, -9)) | 0)) < 8) for (n = 10; n = 10 * n | 0, (0 | m) < 7;) m = m + 1 | 0; else n = 10;
                                    if ((p = (g + 4 | 0) == (0 | s)) & 0 == (0 | (o = (o = 0 | c[g >> 2]) - (r = 0 | v(m = (o >>> 0) / (n >>> 0) | 0, n)) | 0))) m = g; else if (q = 0 == (1 & m | 0) ? 9007199254740992 : 9007199254740994, e = o >>> 0 < (x = n >>> 1) >>> 0 ? .5 : p & (0 | o) == (0 | x) ? 1 : 1.5, D && (q = (x = 45 == (0 | a[B >> 0])) ? -q : q, e = x ? -e : e), c[g >> 2] = r, q + e != q) {
                                        if (999999999 < (c[g >> 2] = x = r + n | 0) >>> 0) for (l = g; (m = l + -4 | 0) >>> (c[l >> 2] = 0) < j >>> 0 && (c[(j = j + -4 | 0) >> 2] = 0), x = 1 + (0 | c[m >> 2]) | 0, 999999999 < (c[m >> 2] = x) >>> 0;) l = m; else m = g;
                                        if (l = 9 * ((y - j | 0) >> 2) | 0, 10 <= (o = 0 | c[j >> 2]) >>> 0) for (n = 10; l = l + 1 | 0, (n = 10 * n | 0) >>> 0 <= o >>> 0;) ;
                                    } else m = g;
                                ...
                                do {
                                    if (t) {
                                        if (n = (0 | l) < (0 | (j = k + (1 & (1 ^ u)) | 0)) & -5 < (0 | l) ? (k = j + -1 - l | 0, i + -1 | 0) : (k = j + -1 | 0, i + -2 | 0), !(8 & h)) {
                                            if (s && 0 != (0 | (A = 0 | c[w + -4 >> 2]))) if ((A >>> 0) % 10 | 0) m = 0; else for (j = 10, m = 0; m = m + 1 | 0, !((A >>> 0) % ((j = 10 * j | 0) >>> 0) | 0);) ; else m = 9;
                                ...
                                if (o = (g = 0 != (0 | k)) ? 1 : h >>> 3 & 1, p = 102 == (32 | n)) j = (u = 0) < (0 | l) ? l : 0; else {
                                    if (((m = E) - (j = 0 | kc(j = (0 | l) < 0 ? r : l, ((0 | j) < 0) << 31 >> 31, E)) | 0) < 2) for (; a[(j = j + -1 | 0) >> 0] = 48, (m - j | 0) < 2;) ;
                                    a[j + -1 >> 0] = 43 + (l >> 31 & 2), a[(j = j + -2 | 0) >> 0] = n, j = m - (u = j) | 0
                                }
                                if (mc(b, 32, f, j = D + 1 + k + o + j | 0, h), ec(b, B, D), mc(b, 48, f, j, 65536 ^ h), p) {
                                    p = r = G + 9 | 0, n = G + 8 | 0, m = o = C >>> 0 < x >>> 0 ? C : x;
                                    do {
                                        if (l = 0 | kc(0 | c[m >> 2], 0, r), (0 | m) == (0 | o)) (0 | l) == (0 | r) && (a[n >> 0] = 48, l = n); else if (G >>> 0 < l >>> 0) for (Vc(0 | G, 48, l - F | 0); G >>> 0 < (l = l + -1 | 0) >>> 0;) ;
                                    } while (ec(b, l, p - l | 0), (m = m + 4 | 0) >>> 0 <= C >>> 0);
                                    if (0 == (8 & h | 0) & (1 ^ g) || ec(b, 2574, 1), m >>> 0 < w >>> 0 & 0 < (0 | k)) for (; ;) {
                                        if (G >>> 0 < (l = 0 | kc(0 | c[m >> 2], 0, r)) >>> 0) for (Vc(0 | G, 48, l - F | 0); G >>> 0 < (l = l + -1 | 0) >>> 0;) ;
                                        if (ec(b, l, (0 | k) < 9 ? k : 9), l = k + -9 | 0, !((m = m + 4 | 0) >>> 0 < w >>> 0 & 9 < (0 | k))) {
                                            k = l;
                                            break
                                        }
                                        k = l
                                    ...
                                    if (x >>> 0 < (g = s ? w : x + 4 | 0) >>> 0 & -1 < (0 | k)) {
                                        ...
                                        do {
                                            (0 | (l = 0 | kc(0 | c[o >> 2], 0, r))) == (0 | r) && (a[p >> 0] = 48, l = p);
                                            do {
                                                if ((0 | o) == (0 | x)) {
                                                    if (m = l + 1 | 0, ec(b, l, 1), t & (0 | k) < 1) {
                                                        l = m;
                                                        break
                                                    }
                                                    ec(b, 2574, 1), l = m
                                        ...
                                        } while (ec(b, l, (0 | (F = s - l | 0)) < (0 | k) ? F : k), (o = o + 4 | 0) >>> 0 < g >>> 0 & -1 < (0 | (k = k - F | 0)))
                                    }
                    ...
                    function cc(b, d, e) {
                        b |= 0, d |= 0, e |= 0;
                        var h, i, j, k, l, m, n, o, f = 0, g = 0, p = S;
                        for (S = S + 224 | 0, l = p + 208 | 0, n = p + 80 | 0, g = 40 + (f = o = (m = p) + 160 | 0) | 0; (0 | (f = f + 4 | (c[f >> 2] = 0))) < (0 | g);) ;
                        c[l >> 2] = c[e >> 2], 0 <= (0 | dc(0, d, l, n, o)) && (k = 32 & (e = 0 | c[b >> 2]), (0 | a[b + 74 >> 0]) < 1 && (c[b >> 2] = -33 & e), 0 | c[(g = b + 48 | 0) >> 2] ? dc(b, d, l, n, o) : (e = 0 | c[(f = b + 44 | 0) >> 2], c[f >> 2] = m, c[(h = b + 28 | 0) >> 2] = m, c[(j = b + 20 | 0) >> 2] = m, c[g >> 2] = 80, c[(i = b + 16 | 0) >> 2] = m + 80, dc(b, d, l, n, o), 0 | e && (X[3 & c[b + 36 >> 2]](b, 0, 0), c[f >> 2] = e, c[g >> 2] = 0, c[i >> 2] = 0, c[h >> 2] = 0, c[j >> 2] = 0)), c[b >> 2] = c[b >> 2] | k), S = p
                    }

                    function dc(d, e, f, h, i) {
                        d |= 0, f |= 0, h |= 0, i |= 0;
                        var v, w, x, y, A, B, C, D, E, j = 0, k = 0, l = 0, m = 0, n = 0, o = 0, p = 0, q = 0, r = 0, s = 0,
                            t = 0, u = 0, G = 0, F = S;
                        S = S + 64 | 0, B = F + 40 | 0, E = (w = F) + 48 | 0, C = F + 60 | 0, c[(D = F + 56 | 0) >> 2] = e |= 0, A = 0 != (0 | d), y = v = w + 40 | 0, w = w + 39 | 0, x = 4 + E | 0, m = j = e = 0;
                        a:for (; ;) {
                            do {
                                do {
                                    if (-1 < (0 | e)) {
                            ...
                            if (l = 0 | c[D >> 2], o = 0 | fc(j = 0 | a[l + 1 >> 0]) ? (k = (o = 36 == (0 | a[l + 2 >> 0])) ? 3 : 1, r = o ? j + -48 | 0 : -1, o ? 1 : m) : (r = -(k = 1), m), c[D >> 2] = k = l + k | 0, 31 < (l = ((j = 0 | a[k >> 0]) << 24 >> 24) - 32 | 0) >>> 0 | 0 == (1 << l & 75913 | 0)) n = 0; else for (j = 0; ;) {
                            ...
                            if (j << 24 >> 24 == 42) {
                                if (0 != (0 | fc(j = 0 | a[(l = k + 1 | 0) >> 0])) && 36 == (0 | a[k + 2 >> 0])) c[i + (j + -48 << 2) >> 2] = 10, m = 1, j = k + 3 | 0, k = 0 | c[h + ((0 | a[l >> 0]) - 48 << 3) >> 2]; else {
                                    if (0 | o) {
                                        e = -1;
                                        break
                                    }
                            ...
                            do {
                                if (46 == (0 | a[l >> 0])) {
                                    ...
                                    if (0 | fc(k = 0 | a[(j = l + 2 | 0) >> 0]) && 36 == (0 | a[l + 3 >> 0])) {
                            ...
                            do {
                                if (l << 24 >> 24 == 19) {
                                    ...
                                    if (k) {
                                        c[i + (r << 2) >> 2] = m, r = 0 | c[4 + (m = h + (r << 3) | 0) >> 2], c[(u = B) >> 2] = c[m >> 2], c[u + 4 >> 2] = r, u = 52;
                                        break
                                    }
                                    if (!A) {
                                        e = 0;
                            ...
                            d:do {
                                if (53 == (0 | u)) {
                                        ...
                                        switch (0 | l) {
                                            ...
                                            case 111:
                                                n = 0 == (8 & (j = r) | 0) | (0 | (l = y - (o = 0 | function (b, c, d) {
                                                    if (d |= 0, !(0 == (0 | (b |= 0)) & 0 == (0 | (c |= 0)))) for (; a[(d = d + -1 | 0) >> 0] = 7 & b | 48, !(0 == (0 | (b = 0 | Rc(0 | b, 0 | c, 3))) & 0 == (0 | (c = 0 | z())));) ;
                                                    return 0 | d
                                                }(p = 0 | c[(q = B) >> 2], q = 0 | c[q + 4 >> 2], v)) | 0)) < (0 | n) ? n : l + 1 | 0, l = 0, k = 2522, u = 71;
                                                break;
                                            case 105:
                                            case 100:
                                                if (j = 0 | c[(k = B) >> 2], (0 | (k = 0 | c[k + 4 >> 2])) < 0) {
                                                    j = 0 | Nc(0, 0, 0 | j, 0 | k), k = 0 | z(), c[(l = B) >> 2] = j, c[l + 4 >> 2] = k, l = 1, m = 2522, u = 70;
                                                    break e
                                                }
                                                l = 0 != (2049 & r | 0) & 1, m = 0 == (2048 & r | 0) ? 0 == (1 & r | 0) ? 2522 : 2524 : 2523, u = 70;
                                                break e;
                                            case 117:
                                                j = 0 | c[(k = B) >> 2], k = 0 | c[k + 4 >> 2], l = 0, m = 2522, u = 70;
                                                break;
                                            case 99:
                                                a[w >> 0] = c[B >> 2], p = w, o = j, m = 1, l = 0, k = 2522, j = y;
                                                break;
                                            case 115:
                                                p = q = 0 == (0 | (q = 0 | c[B >> 2])) ? 2532 : q, o = j, m = (G = 0 == (0 | (r = 0 | function (b, d) {
                                                    b |= 0;
                                                    var e = 0, f = 0, e = 0 != (0 | (d |= 0));
                                                    a:do {
                                                        if (e & 0 != (3 & b | 0)) for (; ;) {
                                                            if (!(0 | a[b >> 0])) break a;
                                                    ...
                                                    return 0 | b
                                                }(q, n)))) ? n : r - q | 0, l = 0, k = 2522, j = G ? q + n | 0 : r;
                                                break;
                                            case 67:
                                    ...
                                    f:do {
                                        if (65 == (0 | u)) o = 0 | ic(p = 0 | c[(q = B) >> 2], q = 0 | c[q + 4 >> 2], v, 32 & m), n = k, l = (G = 0 == (8 & j | 0) | 0 == (0 | p) & 0 == (0 | q)) ? 0 : 2, k = G ? 2522 : 2522 + (m >>> 4) | 0, u = 71; else if (70 == (0 | u)) o = 0 | kc(p = j, q = k, v), j = r, k = m, u = 71; else if (78 == (0 | u)) {
                                            for (j = u = 0, o = l; k = 0 | c[o >> 2];) {
                                                if ((m = (0 | (k = 0 | nc(C, k))) < 0) | (n - j | 0) >>> 0 < k >>> 0) {
                                                    u = 82;
                                                    break
                                                }
                                            ...
                                            if (mc(d, 32, s, j, r), j) for (m = 0; ;) {
                                                if (!(k = 0 | c[l >> 2])) {
                                                    u = 88;
                                                    break f
                                                }
                                                if ((0 | j) < (0 | (m = (k = 0 | nc(C, k)) + m | 0))) {
                                                    u = 88;
                                                    break f
                                                }
                                                if (ec(d, C, k), j >>> 0 <= m >>> 0) {
                                    ...
                                    if (71 == (0 | u)) G = (u = 0) != (0 | n) | (m = 0 != (0 | p) | 0 != (0 | q)), m = y - o + (1 & (1 ^ m)) | 0, p = G ? o : v, o = -1 < (0 | n) ? -65537 & j : j, m = G ? (0 | m) < (0 | n) ? n : m : 0, j = y; else if (88 == (0 | u)) {
                                        u = 0, mc(d, 32, s, j, 8192 ^ r), j = (0 | j) < (0 | s) ? s : j;
                                        break
                                    }
                                    mc(d, 32, j = (0 | s) < (0 | (G = (q = (0 | m) < (0 | (r = j - p | 0)) ? r : m) + l | 0)) ? G : s, G, o), ec(d, k, l), mc(d, 48, j, G, 65536 ^ o), mc(d, 48, q, r, 0), ec(d, p, r), mc(d, 32, j, G, 8192 ^ o)
                                }
                            } while (0);
                            m = t
                        }
                        g:do {
                            if (91 == (0 | u) && !d) if (m) {
                                for (e = 1; j = 0 | c[i + (e << 2) >> 2];) if (hc(h + (e << 3) | 0, j, f), 10 <= (e = e + 1 | 0) >>> 0) {
                                    e = 1;
                                    break g
                                }
                                for (j = 0; ;) {
                    ...
                    function gc(b) {
                        var d = 0, e = 0, f = 0, e = 0 | c[(b |= 0) >> 2];
                        if (0 | fc((d = 0 | a[e >> 0]) << 24 >> 24)) for (f = d, d = 0; d = (10 * d | 0) - 48 + (f << 24 >> 24) | 0, c[b >> 2] = e = e + 1 | 0, 0 != (0 | fc((f = 0 | a[e >> 0]) << 24 >> 24));) ; else d = 0;
                        return 0 | d
                    }
                    ...
                    function ic(b, c, e, f) {
                        if (e |= 0, f |= 0, !(0 == (0 | (b |= 0)) & 0 == (0 | (c |= 0)))) for (; a[(e = e + -1 | 0) >> 0] = 0 | d[480 + (15 & b) >> 0] | f, !(0 == (0 | (b = 0 | Rc(0 | b, 0 | c, 4))) & 0 == (0 | (c = 0 | z())));) ;
                        return 0 | e
                    }
                    ...
                    function kc(b, c, d) {
                        d |= 0;
                        var e, f = 0, g = 0;
                        if (0 < (c |= 0) >>> 0 | 0 == (0 | c) & 4294967295 < (b |= 0) >>> 0) for (; g = 0 | Mc(0 | (e = b), 0 | (f = c), 0 | (g = 0 | Lc(0 | (b = 0 | Qc(0 | b, 0 | c, 10, 0)), 0 | (c = 0 | z()), -10, -1)), 0 | z()), z(), a[(d = d + -1 | 0) >> 0] = 255 & g | 48, 9 < f >>> 0 | 9 == (0 | f) & 4294967295 < e >>> 0;) ;
                    ...
                    function mc(a, b, c, d, e) {
                        a |= 0, b |= 0;
                        var f, g = S;
                        if (S = S + 256 | 0, f = g, (0 | (d |= 0)) < (0 | (c |= 0)) & 0 == (73728 & (e |= 0) | 0)) {
                            if (Vc(0 | f, b << 24 >> 24 | 0, 0 | ((e = c - d | 0) >>> 0 < 256 ? e : 256)), 255 < e >>> 0) {
                                for (d = e; ec(a, f, 256), 255 < (d = d + -256 | 0) >>> 0;) ;
                                e &= 255
                            }
                            ec(a, f, e)
                        }
                    ...
                    function pc(b, d, e) {
                        b |= 0, d |= 0;
                        var i, f = 0, g = 0, h = 0;
                        (f = 0 | c[(g = 16 + (e |= 0) | 0) >> 2]) ? h = 5 : 0 | function (b) {
                            var d = 0, e = 0 | a[(d = 74 + (b |= 0) | 0) >> 0];
                            return a[d >> 0] = 255 + e | e, 0 | (d = 8 & (d = 0 | c[b >> 2]) ? (c[b >> 2] = 32 | d, -1) : (c[8 + b >> 2] = 0, d = (c[4 + b >> 2] = 0) | c[44 + b >> 2], c[28 + b >> 2] = d, c[20 + b >> 2] = d, c[16 + b >> 2] = d + (0 | c[48 + b >> 2]), 0))
                        }(e) || (f = 0 | c[g >> 2], h = 5);
                        a:do {
                            if (5 == (0 | h)) {
                    ...
                    function sc(a, b) {
                        b |= 0;
                        var e, f, d = 0;
                        switch (g[h >> 3] = a = +a, f = 0 | Rc(0 | (d = 0 | c[h >> 2]), 0 | (e = 0 | c[h + 4 >> 2]), 52), z(), 2047 & f) {
                            case 0:
                                d = 0 != a ? (a = +sc(0x10000000000000000 * a, b), (0 | c[b >> 2]) - 64 | 0) : 0, c[b >> 2] = d;
                                break;
                            case 2047:
                                break;
                            default:
                    ...
                    function uc(b) {
                        var g, c = 0, e = 0, f = 0, c = 0 | a[(b |= 0) >> 0];
                        a:do {
                            if (c << 24 >> 24) for (e = b, f = 4, b = 1033; ;) {
                    ...
                    function zc(a, b, d, e, f, g) {
                        a |= 0, d |= 0, e |= 0, f |= 0, g |= 0;
                        var j, k, l, h = 0, i = 0, m = S;
                        S = S + 240 | 0, c[(k = (l = m) + 232 | 0) >> 2] = b |= 0, c[(j = 4 + k | 0) >> 2] = d, c[l >> 2] = a;
                        a:do {
                            if (1 != (0 | b) | 0 != (0 | d) && 1 <= (0 | oa(h = a + (0 - (0 | c[g + (e << 2) >> 2])) | 0, a))) for (b = h, i = 1, h = 0 == (0 | f); ;) {
                                if (h & 1 < (0 | e)) {
                                    if (-1 < (0 | oa(h = a + -4 | 0, b))) {
                                        b = a, h = i, d = 10;
                                        break a
                                ...
                                if (d = i + 1 | 0, c[l + (i << 2) >> 2] = b, yc(k, f = 0 | Bc(k)), e = f + e | 0, !(1 != (0 | c[k >> 2]) | 0 != (0 | c[j >> 2]))) {
                                    h = d, d = 10;
                                    break a
                                }
                        ...
                        9 == (0 | d) && 0 == (0 | f) && (b = a, h = 1, d = 10), 10 == (0 | d) && (Dc(l, h), xc(b, e, g)), S = m
                    }
                    ...
                    function Bc(a) {
                        var b;
                        return (b = 0 | Cc((0 | c[(a |= 0) >> 2]) - 1 | 0)) ? 0 | b : 0 | (0 == (0 | (a = 0 | Cc(0 | c[a + 4 >> 2]))) ? 0 : a + 32 | 0)
                    }

                    function Cc(a) {
                        var b = 0;
                        if (a |= 0) if (1 & a) b = 0; else for (b = 0; b = b + 1 | 0, !(2 & a);) a >>>= 1; else b = 32;
                        return 0 | b
                    }
                    ...
                    function Dc(a, b) {
                        a |= 0;
                        var f, d = 0, e = S;
                        if (S = S + 256 | 0, d = e, 2 <= (0 | (b |= 0))) for (Uc(0 | (c[a + (b << 2) >> 2] = d), 0 | c[a >> 2], 4), d = 0; Uc(0 | c[(f = a + (d << 2) | 0) >> 2], 0 | c[a + ((d = d + 1 | 0) << 2) >> 2], 4), c[f >> 2] = 4 + (0 | c[f >> 2]), (0 | d) != (0 | b);) ;
                        S = e
                    }
                    ...
                    function Ec(a) {
                        ...
                        var b = 0, d = 0, e = 0, f = 0, g = 0, h = 0, i = 0, j = 0, k = 0, l = 0, m = 0, n = 0, o = 0,
                            p = 0, q = 0, r = 0, s = 0, t = 0, u = 0, v = 0, w = S;
                        S = S + 16 | 0, n = w;
                        do {
                            if (a >>> 0 < 245) {
                                if (m = 0 | c[923], 3 & (d = (a = (k = a >>> 0 < 11 ? 16 : a + 11 & -8) >>> 3) ? m >>> a : m) | 0) return a = 0 | c[(b = 8 + (f = 3732 + ((e = (1 & d ^ 1) + a | 0) << 1 << 2) | 0) | 0) >> 2], (0 | (d = 0 | c[(g = a + 8 | 0) >> 2])) == (0 | f) ? c[923] = m & ~(1 << e) : (c[d + 12 >> 2] = f, c[b >> 2] = d), c[a + 4 >> 2] = 3 | (v = e << 3), c[(v = a + v + 4 | 0) >> 2] = 1 | c[v >> 2], S = w, 0 | g;
                                if ((l = 0 | c[925]) >>> 0 < k >>> 0) {
                                    if (0 | d) return g = 0 | c[(b = 8 + (d = 3732 + ((e = ((a = (e = (i = (e = ((e = d << a & ((e = 2 << a) | 0 - e)) & 0 - e) - 1 | 0) >>> 12 & 16) ? e >>> i : e) >>> 5 & 8) | i | (g = (e = a ? e >>> a : e) >>> 2 & 4) | (b = (e = g ? e >>> g : e) >>> 1 & 2) | (d = (e = b ? e >>> b : e) >>> 1 & 1)) + (d ? e >>> d : e) | 0) << 1 << 2) | 0) | 0) >> 2], (0 | (a = 0 | c[(i = g + 8 | 0) >> 2])) == (0 | d) ? c[923] = a = m & ~(1 << e) : (c[a + 12 >> 2] = d, c[b >> 2] = a, a = m), h = (v = e << 3) - k | 0, c[g + 4 >> 2] = 3 | k, c[4 + (f = g + k | 0) >> 2] = 1 | h, c[g + v >> 2] = h, 0 | l && (e = 0 | c[928], d = 3732 + ((b = l >>> 3) << 1 << 2) | 0, a = a & (b = 1 << b) ? 0 | c[(b = a = d + 8 | 0) >> 2] : (c[923] = a | b, b = d + 8 | 0, d), c[b >> 2] = e, c[a + 12 >> 2] = e, c[e + 8 >> 2] = a, c[e + 12 >> 2] = d), c[925] = h, c[928] = f, S = w, 0 | i;
                                    if (g = 0 | c[924]) {
                                        for (j = 0 | c[3996 + (((e = (j = (f = (j = (g & 0 - g) - 1 | 0) >>> 12 & 16) ? j >>> f : j) >>> 5 & 8) | f | (h = (j = e ? j >>> e : j) >>> 2 & 4) | (d = (j = h ? j >>> h : j) >>> 1 & 2) | (i = (j = d ? j >>> d : j) >>> 1 & 1)) + (i ? j >>> i : j) << 2) >> 2], i = (-8 & c[j + 4 >> 2]) - k | 0, d = j; (a = 0 | c[d + 16 >> 2]) || (a = 0 | c[d + 20 >> 2]);) i = (h = (d = (-8 & c[a + 4 >> 2]) - k | 0) >>> 0 < i >>> 0) ? d : i, d = a, j = h ? a : j;
                                        if (j >>> 0 < (h = j + k | 0) >>> 0) {
                                            ...
                                            do {
                                                if (0 | f) {
                                                    if (b = 0 | c[j + 28 >> 2], (0 | j) == (0 | c[(a = 3996 + (b << 2) | 0) >> 2])) {
                                                        if (!(c[a >> 2] = d)) {
                                                            c[924] = g & ~(1 << b);
                                                            break
                                                        }
                                            ...
                                            return i >>> 0 < 16 ? (c[j + 4 >> 2] = 3 | (v = i + k | 0), c[(v = j + v + 4 | 0) >> 2] = 1 | c[v >> 2]) : (c[j + 4 >> 2] = 3 | k, c[h + 4 >> 2] = 1 | i, c[h + i >> 2] = i, 0 | l && (e = 0 | c[928], d = 3732 + ((b = l >>> 3) << 1 << 2) | 0, a = (b = 1 << b) & m ? 0 | c[(b = a = d + 8 | 0) >> 2] : (c[923] = b | m, b = d + 8 | 0, d), c[b >> 2] = e, c[a + 12 >> 2] = e, c[e + 8 >> 2] = a, c[e + 12 >> 2] = d), c[925] = i, c[928] = h), S = w, j + 8 | 0
                                        }
                                        m = k
                                    } else m = k
                                } else m = k
                            } else if (a >>> 0 <= 4294967231) if (k = -8 & (a = a + 11 | 0), e = 0 | c[924]) {
                                d = 0 - k | 0, j = (a >>>= 8) ? 16777215 < k >>> 0 ? 31 : 1 & ((r = 7 + (j = 14 - ((i = (520192 + (j = a << (m = (a + 1048320 | 0) >>> 16 & 8)) | 0) >>> 16 & 4) | m | (r = (245760 + (j <<= i) | 0) >>> 16 & 2)) + (j << r >>> 15) | 0) | 0) ? k >>> r : k) | j << 1 : 0, a = 0 | c[3996 + (j << 2) >> 2];
                                a:do {
                                ...
                                if (61 == (0 | r)) {
                                    if (0 == (0 | f) & 0 == (0 | a)) {
                                        ...
                                        f = 0 | c[3996 + (((h = (f = (i = (f = (a & 0 - a) - 1 | 0) >>> 12 & 16) ? f >>> i : f) >>> 5 & 8) | i | (j = (f = h ? f >>> h : f) >>> 2 & 4) | (m = (f = j ? f >>> j : f) >>> 1 & 2) | (a = (f = m ? f >>> m : f) >>> 1 & 1)) + (a ? f >>> a : f) << 2) >> 2], a = 0
                                    }
                                    f ? r = 65 : (i = d, g = a)
                                }
                                if (65 == (0 | r)) for (; ;) {
                                ...
                                if (0 != (0 | g) && i >>> 0 < ((0 | c[925]) - k | 0) >>> 0 && g >>> 0 < (l = g + k | 0) >>> 0) {
                                    ...
                                    do {
                                        if (h) {
                                            if (a = 0 | c[g + 28 >> 2], (0 | g) == (0 | c[(d = 3996 + (a << 2) | 0) >> 2])) {
                                                if (!(c[d >> 2] = b)) {
                                                    e &= ~(1 << a), c[924] = e;
                                                    break
                                                }
                                    ...
                                    b:do {
                                        if (i >>> 0 < 16) c[g + 4 >> 2] = 3 | (v = i + k | 0), c[(v = g + v + 4 | 0) >> 2] = 1 | c[v >> 2]; else {
                                            if (c[g + 4 >> 2] = 3 | k, c[l + 4 >> 2] = 1 | i, b = (c[l + i >> 2] = i) >>> 3, i >>> 0 < 256) {
                                                d = 3732 + (b << 1 << 2) | 0, a = (a = 0 | c[923]) & (b = 1 << b) ? 0 | c[(b = a = d + 8 | 0) >> 2] : (c[923] = a | b, b = d + 8 | 0, d), c[b >> 2] = l, c[a + 12 >> 2] = l, c[l + 8 >> 2] = a, c[l + 12 >> 2] = d;
                                                break
                                            }
                                            if (b = 3996 + ((d = (b = i >>> 8) ? 16777215 < i >>> 0 ? 31 : 1 & ((v = 7 + (d = 14 - ((t = (520192 + (d = b << (u = (b + 1048320 | 0) >>> 16 & 8)) | 0) >>> 16 & 4) | u | (v = (245760 + (d <<= t) | 0) >>> 16 & 2)) + (d << v >>> 15) | 0) | 0) ? i >>> v : i) | d << 1 : 0) << 2) | 0, c[l + 28 >> 2] = d, c[4 + (a = l + 16 | 0) >> 2] = 0, c[a >> 2] = 0, !(e & (a = 1 << d))) {
                                                c[924] = e | a, c[b >> 2] = l, c[l + 24 >> 2] = b, c[l + 12 >> 2] = l, c[l + 8 >> 2] = l;
                                                break
                                            }
                                            b = 0 | c[b >> 2];
                                            c:do {
                                                if ((-8 & c[b + 4 >> 2] | 0) != (0 | i)) {
                                                    for (e = i << (31 == (0 | d) ? 0 : 25 - (d >>> 1) | 0); a = 0 | c[(d = b + 16 + (e >>> 31 << 2) | 0) >> 2];) {
                                                        if ((-8 & c[a + 4 >> 2] | 0) == (0 | i)) {
                                                            b = a;
                                                            break c
                                                        }
                        ...
                        if (m >>> 0 <= (d = 0 | c[925]) >>> 0) return b = 0 | c[928], 15 < (a = d - m | 0) >>> 0 ? (c[928] = v = b + m | 0, c[925] = a, c[v + 4 >> 2] = 1 | a, c[b + d >> 2] = a, c[b + 4 >> 2] = 3 | m) : (c[925] = 0, c[928] = 0, c[b + 4 >> 2] = 3 | d, c[(v = b + d + 4 | 0) >> 2] = 1 | c[v >> 2]), S = w, b + 8 | 0;
                        if (m >>> 0 < (h = 0 | c[926]) >>> 0) return c[926] = t = h - m | 0, v = 0 | c[929], c[929] = u = v + m | 0, c[u + 4 >> 2] = 1 | t, c[v + 4 >> 2] = 3 | m, S = w, v + 8 | 0;
                        if (i = m + 48 | 0, (k = (g = (a = 0 | c[1041] ? 0 | c[1043] : (c[1043] = 4096, c[1042] = 4096, c[1044] = -1, c[1045] = -1, c[1046] = 0, c[1034] = 0, c[1041] = -16 & n ^ 1431655768, 4096)) + (j = m + 47 | 0) | 0) & (e = 0 - a | 0)) >>> 0 <= m >>> 0) return S = w, (v = 0) | v;
                        if (0 | (a = 0 | c[1033]) && (n = (l = 0 | c[1031]) + k | 0) >>> 0 <= l >>> 0 | a >>> 0 < n >>> 0) return S = w, (v = 0) | v;
                        d:do {
                            if (4 & c[1034]) b = 0, r = 143; else {
                                d = 0 | c[929];
                                e:do {
                                    if (d) {
                                        for (f = 4140; !((a = 0 | c[f >> 2]) >>> 0 <= d >>> 0 && (a + (0 | c[(q = f + 4 | 0) >> 2]) | 0) >>> 0 > d >>> 0);) {
                                            if (!(a = 0 | c[f + 8 >> 2])) {
                                                r = 128;
                                                break e
                                            }
                                        ...
                                        if ((b = g - h & e) >>> 0 < 2147483647) if ((0 | (a = 0 | Jc(b))) == ((0 | c[f >> 2]) + (0 | c[q >> 2]) | 0)) {
                                            if (-1 != (0 | a)) {
                                                h = a, g = b, r = 145;
                                                break d
                                            }
                                        } else e = a, r = 136; else b = 0
                                    } else r = 128
                                } while (0);
                                do {
                                    if (128 == (0 | r)) if (-1 != (0 | (d = 0 | Jc(0))) && (b = d, p = (b = (0 == ((p = (o = 0 | c[1042]) - 1 | 0) & b | 0) ? 0 : (p + b & 0 - o) - b | 0) + k | 0) + (o = 0 | c[1031]) | 0, m >>> 0 < b >>> 0 & b >>> 0 < 2147483647)) {
                        ...
                        if (143 == (0 | r) && k >>> 0 < 2147483647 && !(-1 == (0 | (s = 0 | Jc(k))) | 1 ^ (t = (m + 40 | 0) >>> 0 < (u = (q = 0 | Jc(0)) - s | 0) >>> 0) | s >>> 0 < q >>> 0 & -1 != (0 | s) & -1 != (0 | q) ^ 1) && (h = s, g = t ? u : b, r = 145), 145 == (0 | r)) {
                            b = (0 | c[1031]) + g | 0, (c[1031] = b) >>> 0 > (0 | c[1032]) >>> 0 && (c[1032] = b), j = 0 | c[929];
                            f:do {
                                if (j) {
                                    for (f = 4140; ;) {
                                    ...
                                    if (154 == (0 | r) && 0 == (8 & c[f + 12 >> 2] | 0) && j >>> 0 < h >>> 0 & b >>> 0 <= j >>> 0) {
                                        c[e >> 2] = a + g, u = j + (t = 0 == (7 & (t = j + 8 | 0) | 0) ? 0 : 0 - t & 7) | 0, t = (v = (0 | c[926]) + g | 0) - t | 0, c[929] = u, c[926] = t, c[u + 4 >> 2] = 1 | t, c[j + v + 4 >> 2] = 40, c[930] = c[1045];
                                        break
                                    }
                                    for (h >>> 0 < (0 | c[927]) >>> 0 && (c[927] = h), d = h + g | 0, a = 4140; ;) {
                                        if ((0 | c[a >> 2]) == (0 | d)) {
                                            r = 162;
                                            break
                                        }
                                    ...
                                    if (162 == (0 | r) && 0 == (8 & c[a + 12 >> 2] | 0)) {
                                        ...
                                        g:do {
                                            if ((0 | j) == (0 | b)) v = (0 | c[926]) + i | 0, c[926] = v, c[929] = k, c[k + 4 >> 2] = 1 | v; else {
                                                if ((0 | c[928]) == (0 | b)) {
                                                    v = (0 | c[925]) + i | 0, c[925] = v, c[928] = k, c[k + 4 >> 2] = 1 | v, c[k + v >> 2] = v;
                                                    break
                                                }
                                                ...
                                                if (c[(b = b + 4 | 0) >> 2] = -2 & c[b >> 2], c[k + 4 >> 2] = 1 | f, b = (c[k + f >> 2] = f) >>> 3, f >>> 0 < 256) {
                                                    d = 3732 + (b << 1 << 2) | 0, a = (a = 0 | c[923]) & (b = 1 << b) ? 0 | c[(b = a = d + 8 | 0) >> 2] : (c[923] = a | b, b = d + 8 | 0, d), c[b >> 2] = k, c[a + 12 >> 2] = k, c[k + 8 >> 2] = a, c[k + 12 >> 2] = d;
                                                    break
                                                }
                                                b = f >>> 8;
                                                do {
                                                    if (b) {
                                                        ...
                                                        e = 1 & ((v = 7 + (e = 14 - ((t = (520192 + (e = b << (u = (b + 1048320 | 0) >>> 16 & 8)) | 0) >>> 16 & 4) | u | (v = (245760 + (e <<= t) | 0) >>> 16 & 2)) + (e << v >>> 15) | 0) | 0) ? f >>> v : f) | e << 1
                                                    } else e = 0
                                                } while (0);
                                                if (a = 3996 + (e << 2) | 0, c[k + 28 >> 2] = e, c[4 + (b = k + 16 | 0) >> 2] = 0, !((b = (c[b >> 2] = 0) | c[924]) & (d = 1 << e))) {
                                                    c[924] = b | d, c[a >> 2] = k, c[k + 24 >> 2] = a, c[k + 12 >> 2] = k, c[k + 8 >> 2] = k;
                                                    break
                                                }
                                                b = 0 | c[a >> 2];
                                                i:do {
                                    ...
                                    for (a = 4140; !((b = 0 | c[a >> 2]) >>> 0 <= j >>> 0 && j >>> 0 < (v = b + (0 | c[a + 4 >> 2]) | 0) >>> 0);) a = 0 | c[a + 8 >> 2];
                                    for (b = (a = (a = (f = v + -47 | 0) + (0 == (7 & (a = f + 8 | 0) | 0) ? 0 : 0 - a & 7) | 0) >>> 0 < (f = j + 16 | 0) >>> 0 ? j : a) + 8 | 0, u = h + (t = 0 == (7 & (t = h + 8 | 0) | 0) ? 0 : 0 - t & 7) | 0, t = (d = g + -40 | 0) - t | 0, c[929] = u, c[926] = t, c[u + 4 >> 2] = 1 | t, c[h + d + 4 >> 2] = 40, c[930] = c[1045], c[(d = a + 4 | 0) >> 2] = 27, c[b >> 2] = c[1035], c[b + 4 >> 2] = c[1036], c[b + 8 >> 2] = c[1037], c[b + 12 >> 2] = c[1038], c[1035] = h, c[1036] = g, c[1038] = 0, c[1037] = b, b = a + 24 | 0; c[(b = (u = b) + 4 | 0) >> 2] = 7, (u + 8 | 0) >>> 0 < v >>> 0;) ;
                                    if ((0 | a) != (0 | j)) {
                                        if (g = a - j | 0, c[d >> 2] = -2 & c[d >> 2], c[j + 4 >> 2] = 1 | g, b = (c[a >> 2] = g) >>> 3, g >>> 0 < 256) {
                                            d = 3732 + (b << 1 << 2) | 0, a = (a = 0 | c[923]) & (b = 1 << b) ? 0 | c[(b = a = d + 8 | 0) >> 2] : (c[923] = a | b, b = d + 8 | 0, d), c[b >> 2] = j, c[a + 12 >> 2] = j, c[j + 8 >> 2] = a, c[j + 12 >> 2] = d;
                                            break
                                        }
                                        if (d = 3996 + ((e = (b = g >>> 8) ? 16777215 < g >>> 0 ? 31 : 1 & ((v = 7 + (e = 14 - ((t = (520192 + (e = b << (u = (b + 1048320 | 0) >>> 16 & 8)) | 0) >>> 16 & 4) | u | (v = (245760 + (e <<= t) | 0) >>> 16 & 2)) + (e << v >>> 15) | 0) | 0) ? g >>> v : g) | e << 1 : 0) << 2) | 0, c[j + 28 >> 2] = e, c[j + 20 >> 2] = 0, !((b = (c[f >> 2] = 0) | c[924]) & (a = 1 << e))) {
                                            c[924] = b | a, c[d >> 2] = j, c[j + 24 >> 2] = d, c[j + 12 >> 2] = j, c[j + 8 >> 2] = j;
                                            break
                                        }
                                        b = 0 | c[d >> 2];
                                        j:do {
                    ...
                    function Fc(a) {
                        ...
                        if (a |= 0) {
                            e = 0 | c[927], k = (d = a + -8 | 0) + (b = -8 & (a = 0 | c[a + -4 >> 2])) | 0;
                            do {
                                if (1 & a) j = i = d; else {
                                    if (f = 0 | c[d >> 2], !(3 & a)) return;
                                    if (h = f + b | 0, (g = d + (0 - f) | 0) >>> 0 < e >>> 0) return;
                                    if ((0 | c[928]) == (0 | g)) {
                                        if (3 == (3 & (a = 0 | c[(b = k + 4 | 0) >> 2]) | 0)) return c[925] = h, c[b >> 2] = -2 & a, c[g + 4 >> 2] = 1 | h, void (c[g + h >> 2] = h);
                                        j = i = g, b = h;
                                        break
                                    }
                                    if (d = f >>> 3, f >>> 0 < 256) {
                                    ...
                                    if (f) {
                                        if (a = 0 | c[g + 28 >> 2], (0 | c[(b = 3996 + (a << 2) | 0) >> 2]) == (0 | g)) {
                                            if (!(c[b >> 2] = d)) {
                                        ...
                                        c[d + 24 >> 2] = f, 0 | (a = 0 | c[(b = g + 16 | 0) >> 2]) && (c[d + 16 >> 2] = a, c[a + 24 >> 2] = d), (a = 0 | c[b + 4 >> 2]) && (c[d + 20 >> 2] = a, c[a + 24 >> 2] = d), j = i = g, b = h
                                    } else j = i = g, b = h
                                }
                            } while (0);
                            if (!(k >>> 0 <= i >>> 0) && 1 & (d = 0 | c[(a = k + 4 | 0) >> 2])) {
                                if (2 & d) c[a >> 2] = -2 & d, c[j + 4 >> 2] = 1 | b, f = c[i + b >> 2] = b; else {
                                    if ((0 | c[929]) == (0 | k)) return k = (0 | c[926]) + b | 0, c[926] = k, c[929] = j, c[j + 4 >> 2] = 1 | k, void ((0 | j) == (0 | c[928]) && (c[928] = 0, c[925] = 0));
                                    if ((0 | c[928]) == (0 | k)) return k = (0 | c[925]) + b | 0, c[925] = k, c[928] = i, c[j + 4 >> 2] = 1 | k, void (c[i + k >> 2] = k);
                                    f = (-8 & d) + b | 0, e = d >>> 3;
                                    do {
                                        if (d >>> 0 < 256) {
                                        ...
                                        if (0 | g) {
                                            if (a = 0 | c[k + 28 >> 2], (0 | c[(b = 3996 + (a << 2) | 0) >> 2]) == (0 | k)) {
                                                if (!(c[b >> 2] = d)) {
                                                    c[924] = c[924] & ~(1 << a);
                                                    break
                                                }
                                    ...
                                    if (c[j + 4 >> 2] = 1 | f, c[i + f >> 2] = f, (0 | j) == (0 | c[928])) return void (c[925] = f)
                                }
                                if (a = f >>> 3, f >>> 0 < 256) return d = 3732 + (a << 1 << 2) | 0, b = (b = 0 | c[923]) & (a = 1 << a) ? 0 | c[(a = b = d + 8 | 0) >> 2] : (c[923] = b | a, a = d + 8 | 0, d), c[a >> 2] = j, c[b + 12 >> 2] = j, c[j + 8 >> 2] = b, void (c[j + 12 >> 2] = d);
                                b = 3996 + ((e = (a = f >>> 8) ? 16777215 < f >>> 0 ? 31 : 1 & ((k = 7 + (e = 14 - ((h = (520192 + (e = a << (i = (a + 1048320 | 0) >>> 16 & 8)) | 0) >>> 16 & 4) | i | (k = (245760 + (e <<= h) | 0) >>> 16 & 2)) + (e << k >>> 15) | 0) | 0) ? f >>> k : f) | e << 1 : 0) << 2) | 0, c[j + 28 >> 2] = e, c[j + 20 >> 2] = 0, a = (c[j + 16 >> 2] = 0) | c[924], d = 1 << e;
                                a:do {
                                    if (a & d) {
                                        a = 0 | c[b >> 2];
                                        b:do {
                                    ...
                                    } else c[924] = a | d, c[b >> 2] = j, c[j + 24 >> 2] = b, c[j + 12 >> 2] = j, c[j + 8 >> 2] = j
                                } while (0);
                    ...
                    function Gc(a, b) {
                        var d = 0, e = 0, f = 0, g = 0, h = 0, i = 0, j = 0, j = (a |= 0) + (b |= 0) | 0,
                            d = 0 | c[a + 4 >> 2];
                        do {
                            if (1 & d) i = a, a = b; else {
                                if (e = 0 | c[a >> 2], !(3 & d)) return;
                                if (h = e + b | 0, (0 | c[928]) == (0 | (g = a + (0 - e) | 0))) {
                                    if (3 == (3 & (d = 0 | c[(a = j + 4 | 0) >> 2]) | 0)) return c[925] = h, c[a >> 2] = -2 & d, c[g + 4 >> 2] = 1 | h, c[j >> 2] = h;
                                    i = g, a = h;
                                    break
                                }
                                if (b = e >>> 3, e >>> 0 < 256) {
                                ...
                                if (f) {
                                    if (d = 0 | c[g + 28 >> 2], (0 | c[(a = 3996 + (d << 2) | 0) >> 2]) == (0 | g)) {
                                        if (!(c[a >> 2] = b)) {
                                    ...
                                    c[b + 24 >> 2] = f, 0 | (d = 0 | c[(a = g + 16 | 0) >> 2]) && (c[b + 16 >> 2] = d, c[d + 24 >> 2] = b), (d = 0 | c[a + 4 >> 2]) && (c[b + 20 >> 2] = d, c[d + 24 >> 2] = b), i = g, a = h
                                } else i = g, a = h
                            }
                        } while (0);
                        if (2 & (b = 0 | c[(d = j + 4 | 0) >> 2])) c[d >> 2] = -2 & b, c[i + 4 >> 2] = 1 | a, c[i + a >> 2] = a; else {
                            if ((0 | c[929]) == (0 | j)) return j = (0 | c[926]) + a | 0, c[926] = j, c[929] = i, c[i + 4 >> 2] = 1 | j, (0 | i) == (0 | c[928]) && (c[928] = 0, c[925] = 0);
                            if ((0 | c[928]) == (0 | j)) return j = (0 | c[925]) + a | 0, c[925] = j, c[928] = i, c[i + 4 >> 2] = 1 | j, c[i + j >> 2] = j;
                            g = (-8 & b) + a | 0, e = b >>> 3;
                            do {
                                if (b >>> 0 < 256) {
                                ...
                                if (0 | f) {
                                    if (d = 0 | c[j + 28 >> 2], (0 | c[(a = 3996 + (d << 2) | 0) >> 2]) == (0 | j)) {
                                        if (!(c[a >> 2] = b)) {
                                            c[924] = c[924] & ~(1 << d);
                                            break
                                        }
                            ...
                            if (c[i + 4 >> 2] = 1 | g, c[i + g >> 2] = g, (0 | i) == (0 | c[928])) return c[925] = g;
                            a = g
                        }
                        if (d = a >>> 3, a >>> 0 < 256) return b = 3732 + (d << 1 << 2) | 0, a = (a = 0 | c[923]) & (d = 1 << d) ? 0 | c[(d = a = b + 8 | 0) >> 2] : (c[923] = a | d, d = b + 8 | 0, b), c[d >> 2] = i, c[a + 12 >> 2] = i, c[i + 8 >> 2] = a, c[i + 12 >> 2] = b;
                        if (b = 3996 + ((f = (d = a >>> 8) ? 16777215 < a >>> 0 ? 31 : 1 & ((j = 7 + (f = 14 - ((g = (520192 + (f = d << (h = (d + 1048320 | 0) >>> 16 & 8)) | 0) >>> 16 & 4) | h | (j = (245760 + (f <<= g) | 0) >>> 16 & 2)) + (f << j >>> 15) | 0) | 0) ? a >>> j : a) | f << 1 : 0) << 2) | 0, c[i + 28 >> 2] = f, c[i + 20 >> 2] = 0, !((d = (c[i + 16 >> 2] = 0) | c[924]) & (e = 1 << f))) return c[924] = d | e, c[b >> 2] = i, c[i + 24 >> 2] = b, c[i + 12 >> 2] = i, c[i + 8 >> 2] = i;
                        d = 0 | c[b >> 2];
                        a:do {
                            if ((-8 & c[d + 4 >> 2] | 0) != (0 | a)) {
                                for (f = a << (31 == (0 | f) ? 0 : 25 - (f >>> 1) | 0); b = 0 | c[(e = d + 16 + (f >>> 31 << 2) | 0) >> 2];) {
                                    if ((-8 & c[b + 4 >> 2] | 0) == (0 | a)) {
                                        d = b;
                                        break a
                                    }
                                ...
                                return c[e >> 2] = i, c[i + 24 >> 2] = d, c[i + 12 >> 2] = i, c[i + 8 >> 2] = i
                            }
                        } while (0);
                    ...
                    function Ic(a, b, d) {
                        var e;
                        return a |= 0, 0 != (3 & (b |= 0) | 0) | 0 == (0 | (e = b >>> 2)) || 1073741823 + e & e | 0 ? 28 : (-64 - b | 0) >>> 0 < (d |= 0) >>> 0 || !(b = 0 | function (a, b) {
                            b |= 0;
                            var g, d = 0, e = 0, f = 0, h = 0, i = 0;
                            if ((d = 16 < (a |= 0) >>> 0 ? a : 16) + -1 & d) for (a = 16; a >>> 0 < d >>> 0;) a <<= 1; else a = d;
                            if ((-64 - a | 0) >>> 0 <= b >>> 0) return c[922] = 48, (h = 0) | h;
                            if (!(d = 0 | Ec(12 + (g = b >>> 0 < 11 ? 16 : b + 11 & -8) + a | 0))) return (h = 0) | h;
                            f = d + -8 | 0;
                            do {
                                if (a + -1 & d) {
                                    if (e = 15 < ((e = (d + a + -1 & 0 - a) - 8 | 0) - (b = f) | 0) >>> 0 ? e : e + a | 0, d = (-8 & (i = 0 | c[(a = d + -4 | 0) >> 2])) - (b = e - b | 0) | 0, 3 & i) {
                                        c[(i = e + 4 | 0) >> 2] = d | 1 & c[i >> 2] | 2, c[(d = e + d + 4 | 0) >> 2] = 1 | c[d >> 2], c[a >> 2] = b | 1 & c[a >> 2] | 2, c[i >> 2] = 1 | c[i >> 2], Gc(f, b), a = b = e;
                                        break
                                    }
                            ...
                            return 3 & (a = 0 | c[(d = a + 4 | 0) >> 2]) | 0 && (16 + g | 0) >>> 0 < (h = -8 & a) >>> 0 && (i = h - g | 0, f = b + g | 0, c[d >> 2] = g | 1 & a | 2, c[f + 4 >> 2] = 3 | i, c[(h = b + h + 4 | 0) >> 2] = 1 | c[h >> 2], Gc(f, i)), b + 8 | 0
                        }(16 < b >>> 0 ? b : 16, d)) ? 48 : (c[a >> 2] = b, (a = 0) | a)
                    }

                    function Jc(a) {
                        var b, d = 0;
                        return (a = (b = 0 | c[(d = 4208) >> 2]) + (0 | a) | 0) >>> 0 > (0 | H()) >>> 0 && 0 == (0 | J(0 | a)) ? (c[922] = 48, -1) : (c[d >> 2] = a, 0 | b)
                    }
                    ...
                    function Mc(a, b, c, d) {
                        return 0 | (y((b |= 0) + (d |= 0) + ((c = (a |= 0) + (0 | c) >>> 0) >>> 0 < a >>> 0 | 0) >>> 0 | 0), 0 | c)
                    }
                    ...
                    function Pc(a, b, d, e, f) {
                        f |= 0;
                        var g = 0, h = 0, i = 0, j = 0, k = 0, l = 0, m = 0, n = 0, o = 0, p = 0, l = a |= 0, h = d |= 0,
                            i = n = e |= 0;
                        ...
                        do {
                            if (h) {
                                if (!g) {
                                    ...
                                    return f && (c[f >> 2] = 0 | a, c[f + 4 >> 2] = j | 0 & b), (f = n = 0) | (y(0 | n), f)
                                }
                                if ((g = h - 1 | 0) & h | 0) {
                                ...
                                return 0 | f && (c[f >> 2] = g & l, c[f + 4 >> 2] = 0), 1 == (0 | h) ? (p = 0 | a, 0 | (y(0 | (o = j | 0 & b)), p)) : (o = k >>> ((p = 0 | Oc(0 | h)) >>> 0) | 0, p = k << 32 - p | l >>> (p >>> 0) | 0, 0 | (y(0 | o), p))
                            }
                            ...
                            if (!((g = i - 1 | 0) & i)) return 0 | f && (c[f >> 2] = 0 | a, c[f + 4 >> 2] = g & k | 0 & b), p = k >>> (((o = 0) | Oc(0 | i)) >>> 0), 0 | (y(0 | o), p);
                        ...
                        if (h) {
                            for (k = 0 | Mc(0 | (m = 0 | d), 0 | (l = n | 0 & e), -1, -1), d = 0 | z(), j = i, i = 0; j = g >>> 31 | (e = j) << 1, g = i | g << 1, Nc(0 | k, 0 | d, 0 | (e = a << 1 | e >>> 31 | 0), 0 | (n = a >>> 31 | b << 1 | 0)), i = 1 & (o = (p = 0 | z()) >> 31 | ((0 | p) < 0 ? -1 : 0) << 1), a = 0 | Nc(0 | e, 0 | n, o & m | 0, (((0 | p) < 0 ? -1 : 0) >> 31 | ((0 | p) < 0 ? -1 : 0) << 1) & l | 0), b = 0 | z(), 0 != (0 | (h = h - 1 | 0));) ;
                            k = j, j = 0
                        } else k = i, i = j = 0;
                    ...
                    function Uc(b, d, e) {
                        var f, g, h;
                        if (b |= 0, d |= 0, 8192 <= (0 | (e |= 0))) return I(0 | b, 0 | d, 0 | e), 0 | b;
                    ...
                    var W = [gd, function (a) {
                        ...
                        b |= 0, d |= 0;
                        var e, i, j, k, m, n, o, f = 0, g = 0, h = 0, p = 0, l = S;
                        for (S = S + 32 | 0, i = (g = l) + 16 | 0, f = 0 | c[(j = 28 + (a |= 0) | 0) >> 2], c[g >> 2] = f, f = (0 | c[(k = a + 20 | 0) >> 2]) - f | 0, c[g + 4 >> 2] = f, c[g + 8 >> 2] = b, e = a + 60 | 0, f = f + (c[g + 12 >> (h = 2)] = d) | 0; ;) {
                            if ((0 | f) == (0 | (b = 0 | function (a) {
                                return 0 | ((a |= 0) << 16 >> 16 ? (c[922] = 65535 & a, -1) : 0)
                        ...
                        var e, f;
                        return Uc(0 | (f = 0 | c[(e = 20 + (a |= 0) | 0) >> 2]), 0 | (b |= 0), 0 | (a = (d |= 0) >>> 0 < (a = (0 | c[a + 16 >> 2]) - f | 0) >>> 0 ? d : a)), c[e >> 2] = (0 | c[e >> 2]) + a, 0 | d
                    }], Y = [id, function (a, b, c, d) {
                        ...
                        var j, e = 0, g = 0, h = 0, i = 0, k = 0, l = 0, m = 0, n = 0,
                            e = 0 | c[(j = 308 + (a |= 0) | 0) >> 2], g = 0 | c[a + 316 >> 2], h = 0 | c[a + 320 >> 2];
                        ...
                        var n, p, q, r, s, t, u, v, w, x, y, z, A, B, C, e = 0, g = 0, h = 0, i = 0, j = 0, k = 0, l = 0,
                            m = 0, o = 0, D = 0, E = 0, F = 0, G = 0, H = S;
                        if (S = S + 48 | 0, u = H + 8 | 0, s = H + 40 | 0, r = H + 32 | 0, q = (t = H) + 24 | 0, F = H + 16 | 0, e = 0 | c[(y = 308 + (a |= 0) | 0) >> 2], w = 0 | c[a + 316 >> 2], x = 0 | c[a + 320 >> 2], -1 == (0 | (p = 0 | c[(B = e + ((b |= 0) << 5) + 8 | 0) >> 2]))) G = 0 | c[e + (b << 5) + 16 >> 2], c[w + (b << 2) >> 2] = c[(0 | c[a + 268 >> 2]) + (G << 2) >> 2], c[x + (b << 2) >> 2] = c[(0 | c[a + 272 >> 2]) + (G << 2) >> 2]; else {
                            for (v = 0 | c[(C = e + (b << 5) + 16 | 0) >> 2], j = 0 | c[(0 | c[(z = a + 276 | 0) >> 2]) + (v << 2) >> 2], c[F >> 2] = j, v = 0 | c[(0 | c[(A = a + 280 | 0) >> 2]) + (v << 2) >> 2], c[(D = F + 4 | 0) >> 2] = v, E = 1 == (0 | c[e + (p << 5) + 12 >> 2]) ? -10 : -.10000000149011612, c[s >> 2] = j, c[(j = 4 + s | 0) >> 2] = v, $[3 & c[(v = e + (p << 5) + 24 | 0) >> 2]](a, p, s, r, 1), h = 4 + q | 0, e = 4 + r | 0, g = t + 4 | 0, i = 9, o = 1; f[q >> 2] = (m = 0 * o) + +f[s >> 2], f[h >> 2] = (n = E * o) + +f[j >> 2], $[3 & c[v >> 2]](a, p, q, t, 1), l = +f[t >> 2] - +f[r >> 2], f[t >> 2] = l, k = +f[g >> 2] - +f[e >> 2], !(0 != l | 0 != (f[g >> 2] = k));) {
                            ...
                            6 == (0 | G) ? (l = -k, k = -m) : 8 == (0 | G) && (ia(0, 2397, u), k = l = 0), E = 180 * +ob(0, E, l, k) / 3.1415927410125732, $[3 & c[v >> 2]](a, 0 | c[B >> 2], F, F, 1), G = 0 | c[C >> 2], c[(0 | c[z >> 2]) + (G << 2) >> 2] = c[F >> 2], c[(0 | c[A >> 2]) + (G << 2) >> 2] = c[D >> 2], F = (0 | c[a + 284 >> 2]) + (G << 2) | 0, f[F >> 2] = +f[F >> 2] - E, F = 0 | c[B >> 2], f[w + (b << 2) >> 2] = +f[(0 | c[a + 268 >> 2]) + (G << 2) >> 2] * +f[w + (F << 2) >> 2], G = (0 | c[a + 272 >> 2]) + (G << 2) | 0, E = +f[G >> 2] * +f[x + (F << 2) >> 2], f[x + (b << 2) >> 2] = E, f[G >> 2] = E
                        }
                        (0 | d[4 + (0 | c[a >> 2]) >> 0]) < 4 || (e = 0 | c[y >> 2], g = 0 | c[a + 324 >> 2], j = 0 | c[a + 328 >> 2], h = b << 2, i = c[e + (b << 5) + 16 >> 2] << 2, -1 == (0 | (e = 0 | c[e + (b << 5) + 8 >> 2])) ? (e = 0 | c[a + 296 >> 2], c[g + (h << 2) >> 2] = c[e + (i << 2) >> 2], c[g + ((F = 1 | h) << 2) >> 2] = c[e + ((D = 1 | i) << 2) >> 2], c[g + ((b = 2 | h) << 2) >> 2] = c[e + ((G = 2 | i) << 2) >> 2], f[g + ((e = 3 | h) << 2) >> 2] = 1, a = 0 | c[a + 300 >> 2], c[j + (h << 2) >> 2] = c[a + (i << 2) >> 2], c[j + (F << 2) >> 2] = c[a + (D << 2) >> 2], c[j + (b << 2) >> 2] = c[a + (G << 2) >> 2]) : (F = e << 2, G = (0 | c[a + 296 >> 2]) + (i << 2) | 0, f[(e = g + (h << 2) | 0) >> 2] = +f[G >> 2] * +f[(b = g + (F << 2) | 0) >> 2], f[e + 4 >> 2] = +f[G + 4 >> 2] * +f[b + 4 >> 2], f[e + 8 >> 2] = +f[G + 8 >> 2] * +f[b + 8 >> 2], f[g + ((e = 3 | h) << 2) >> 2] = 1, G = (0 | c[a + 300 >> 2]) + (i << 2) | 0, o = +f[G >> 2], E = +f[(a = j + (F << 2) | 0) >> 2], f[(b = j + (h << 2) | 0) >> 2] = o + E - o * E, E = +f[G + 4 >> 2], o = +f[a + 4 >> 2], f[b + 4 >> 2] = E + o - E * o, o = +f[G + 8 >> 2], E = +f[a + 8 >> 2], f[b + 8 >> 2] = o + E - o * E), f[j + (e << 2) >> 2] = 1), S = H
                    }], $ = [function (a, b, c, d, e) {
                        x(5)
                    }, function (a, b, c, d, e) {
                        ...
                        d |= 0, e |= 0;
                        var B, F, G, H, I, J, K, L, N, O, P, Q, R, T, U, V, W, X, Y, ba, ca, da, ea, i = 0, j = 0, k = 0,
                            l = 0, m = 0, n = 0, o = 0, p = 0, q = 0, r = 0, s = 0, t = 0, u = 0, w = 0, x = 0, y = 0,
                            z = 0, A = 0, C = 0, D = 0, E = 0, M = 0, _ = 0, Z = S;
                        if (S = S + 32 | 0, Y = Z, b = 0 | c[(0 | c[308 + (a |= 0) >> 2]) + ((b |= 0) << 5) + 16 >> 2], i = 0 | c[a + 60 >> 2], R = 0 | c[(0 | c[a + 152 >> 2]) + (b << 2) >> 2], T = 0 | c[i + (24 * b | 0) + 8 >> 2], U = 0 | c[i + (24 * b | 0) + 4 >> 2], V = 1 + T | 0, (0 | (h |= 0)) <= 0) S = Z; else {
                            ...
                            do {
                                ...
                                do {
                                    if (i & a & !(B < 0) & !(z < 0)) {
                                        ...
                                        f[e + (M << 3) >> 2] = (C = k + -1 + j) * +f[R + ((a = 1 + (i = b + V | 0) | 0) << 3) >> 2] + (z = 1 - k) * +f[R + (i << 3) >> 2] + (y = 1 - j) * +f[R + ((_ = b + 1 | 0) << 3) >> 2], z = C * +f[R + (a << 3) + 4 >> 2] + z * +f[R + (i << 3) + 4 >> 2], y *= +f[R + (_ << 3) + 4 >> 2];
                                        break
                                    }
                    ...
                    return {
                        ...
                        _csmGetDrawableConstantFlags: function (a) {
                            var b = 0, d = S;
                            return S = S + 16 | 0, b = d, (a |= 0) ? (b = 0 | c[888 + (0 | c[a >> 2]) >> 2], S = d, 0 | b) : (c[b >> 2] = 1896, c[b + 4 >> 2] = 1411, ia(0, 1269, b), S = d, (b = 0) | b)
                        },
                        _csmGetDrawableCount: function (a) {
                            var b = 0, d = S;
                            return S = S + 16 | 0, b = d, (a |= 0) ? (b = 0 | c[a + 332 >> 2], S = d, 0 | b) : (c[b >> 2] = 1858, c[b + 4 >> 2] = 1411, ia(0, 1269, b), S = d, -1)
                        },
                        _csmGetDrawableDrawOrders: function (a) {
                            var b = 0, d = S;
                            return S = S + 16 | 0, b = d, (a |= 0) ? (b = 0 | c[a + 440 >> 2], S = d, 0 | b) : (c[b >> 2] = 1980, c[b + 4 >> 2] = 1411, ia(0, 1269, b), S = d, (b = 0) | b)
                        },
                        _csmGetDrawableDynamicFlags: function (a) {
                            var b = 0, d = S;
                            return S = S + 16 | 0, b = d, (a |= 0) ? (b = 0 | c[a + 432 >> 2], S = d, 0 | b) : (c[b >> 2] = 1924, c[b + 4 >> 2] = 1411, ia(0, 1269, b), S = d, (b = 0) | b)
                        },
                        _csmGetDrawableIds: function (a) {
                            var b = 0, d = S;
                            return S = S + 16 | 0, b = d, (a |= 0) ? (b = 0 | c[832 + (0 | c[a >> 2]) >> 2], S = d, 0 | b) : (c[b >> 2] = 1878, c[b + 4 >> 2] = 1411, ia(0, 1269, b), S = d, (b = 0) | b)
                        },
                        _csmGetDrawableIndexCounts: function (a) {
                            var b = 0, d = S;
                            return S = S + 16 | 0, b = d, (a |= 0) ? (b = 0 | c[904 + (0 | c[a >> 2]) >> 2], S = d, 0 | b) : (c[b >> 2] = 2182, c[b + 4 >> 2] = 1411, ia(0, 1269, b), S = d, (b = 0) | b)
                        },
                        _csmGetDrawableIndices: function (a) {
                            var b = 0, d = S;
                            return S = S + 16 | 0, b = d, (a |= 0) ? (b = 0 | c[840 + (0 | c[a >> 2]) >> 2], S = d, 0 | b) : (c[b >> 2] = 2208, c[b + 4 >> 2] = 1411, ia(0, 1269, b), S = d, (b = 0) | b)
                        },
                        _csmGetDrawableMaskCounts: function (a) {
                            var b = 0, d = S;
                            return S = S + 16 | 0, b = d, (a |= 0) ? (b = 0 | c[912 + (0 | c[a >> 2]) >> 2], S = d, 0 | b) : (c[b >> 2] = 2056, c[b + 4 >> 2] = 1411, ia(0, 1269, b), S = d, (b = 0) | b)
                        },
                        _csmGetDrawableMasks: function (a) {
                            var b = 0, d = S;
                            return S = S + 16 | 0, b = d, (a |= 0) ? (b = 0 | c[844 + (0 | c[a >> 2]) >> 2], S = d, 0 | b) : (c[b >> 2] = 2081, c[b + 4 >> 2] = 1411, ia(0, 1269, b), S = d, (b = 0) | b)
                        },
                        _csmGetDrawableMultiplyColors: function (a) {
                            var b = 0, d = S;
                            return S = S + 16 | 0, b = d, (a |= 0) ? (b = 0 | c[a + 452 >> 2], S = d, 0 | b) : (c[b >> 2] = 2230, c[b + 4 >> 2] = 1411, ia(0, 1269, b), S = d, (b = 0) | b)
                        },
                        _csmGetDrawableOpacities: function (a) {
                            var b = 0, d = S;
                            return S = S + 16 | 0, b = d, (a |= 0) ? (b = 0 | c[a + 448 >> 2], S = d, 0 | b) : (c[b >> 2] = 2032, c[b + 4 >> 2] = 1411, ia(0, 1269, b), S = d, (b = 0) | b)
                        },
                        _csmGetDrawableParentPartIndices: function (a) {
                            var b = 0, d = S;
                            return S = S + 16 | 0, b = d, (a |= 0) ? (b = 0 | c[876 + (0 | c[a >> 2]) >> 2], S = d, 0 | b) : (c[b >> 2] = 2286, c[b + 4 >> 2] = 1411, ia(0, 1269, b), S = d, (b = 0) | b)
                        },
                        _csmGetDrawableRenderOrders: function (a) {
                            var b = 0, d = S;
                            return S = S + 16 | 0, b = d, (a |= 0) ? (b = 0 | c[a + 436 >> 2], S = d, 0 | b) : (c[b >> 2] = 2005, c[b + 4 >> 2] = 1411, ia(0, 1269, b), S = d, (b = 0) | b)
                        },
                        _csmGetDrawableScreenColors: function (a) {
                            var b = 0, d = S;
                            return S = S + 16 | 0, b = d, (a |= 0) ? (b = 0 | c[a + 456 >> 2], S = d, 0 | b) : (c[b >> 2] = 2259, c[b + 4 >> 2] = 1411, ia(0, 1269, b), S = d, (b = 0) | b)
                        },
                        _csmGetDrawableTextureIndices: function (a) {
                            var b = 0, d = S;
                            return S = S + 16 | 0, b = d, (a |= 0) ? (b = 0 | c[884 + (0 | c[a >> 2]) >> 2], S = d, 0 | b) : (c[b >> 2] = 1951, c[b + 4 >> 2] = 1411, ia(0, 1269, b), S = d, (b = 0) | b)
                        },
                        _csmGetDrawableVertexCounts: function (a) {
                            var b = 0, d = S;
                            return S = S + 16 | 0, b = d, (a |= 0) ? (b = 0 | c[892 + (0 | c[a >> 2]) >> 2], S = d, 0 | b) : (c[b >> 2] = 2101, c[b + 4 >> 2] = 1411, ia(0, 1269, b), S = d, (b = 0) | b)
                        },
                        _csmGetDrawableVertexPositions: function (a) {
                            var b = 0, d = S;
                            return S = S + 16 | 0, b = d, (a |= 0) ? (b = 0 | c[a + 444 >> 2], S = d, 0 | b) : (c[b >> 2] = 2128, c[b + 4 >> 2] = 1411, ia(0, 1269, b), S = d, (b = 0) | b)
                        },
                        _csmGetDrawableVertexUvs: function (a) {
                            var b = 0, d = S;
                            return S = S + 16 | 0, b = d, (a |= 0) ? (b = 0 | c[836 + (0 | c[a >> 2]) >> 2], S = d, 0 | b) : (c[b >> 2] = 2158, c[b + 4 >> 2] = 1411, ia(0, 1269, b), S = d, (b = 0) | b)
                        },
                        ...
                        _csmGetMocVersion: function (a, b) {
                            b |= 0;
                            var d = S;
                            return S = S + 16 | 0, b = d, (a |= 0) ? (a = 0 | ra(a), S = d, 0 | a) : (c[b >> 2] = 1286, c[b + 4 >> 2] = 1303, ia(0, 1269, b), S = d, (a = 0) | a)
                        },
                        _csmGetParameterCount: function (a) {
                            var b = 0, d = S;
                            return S = S + 16 | 0, b = d, (a |= 0) ? (b = 0 | c[a + 540 >> 2], S = d, 0 | b) : (c[b >> 2] = 1610, c[b + 4 >> 2] = 1411, ia(0, 1269, b), S = d, -1)
                        },
                        _csmGetParameterDefaultValues: function (a) {
                            var b = 0, d = S;
                            return S = S + 16 | 0, b = d, (a |= 0) ? (b = 0 | c[932 + (0 | c[a >> 2]) >> 2], S = d, 0 | b) : (c[b >> 2] = 1729, c[b + 4 >> 2] = 1411, ia(0, 1269, b), S = d, (b = 0) | b)
                        },
                        _csmGetParameterIds: function (a) {
                            var b = 0, d = S;
                            return S = S + 16 | 0, b = d, (a |= 0) ? (b = 0 | c[916 + (0 | c[a >> 2]) >> 2], S = d, 0 | b) : (c[b >> 2] = 1631, c[b + 4 >> 2] = 1411, ia(0, 1269, b), S = d, (b = 0) | b)
                        },
                        _csmGetParameterKeyCounts: function (a) {
                            var b = 0, d = S;
                            return S = S + 16 | 0, b = d, (a |= 0) ? (b = 0 | c[a + 616 >> 2], S = d, 0 | b) : (c[b >> 2] = 2347, c[b + 4 >> 2] = 1411, ia(0, 1269, b), S = d, (b = 0) | b)
                        },
                        _csmGetParameterKeyValues: function (a) {
                            var b = 0, d = S;
                            return S = S + 16 | 0, b = d, (a |= 0) ? (b = 0 | c[a + 612 >> 2], S = d, 0 | b) : (c[b >> 2] = 2372, c[b + 4 >> 2] = 1411, ia(0, 1269, b), S = d, (b = 0) | b)
                        },
                        _csmGetParameterMaximumValues: function (a) {
                            var b = 0, d = S;
                            return S = S + 16 | 0, b = d, (a |= 0) ? (b = 0 | c[924 + (0 | c[a >> 2]) >> 2], S = d, 0 | b) : (c[b >> 2] = 1700, c[b + 4 >> 2] = 1411, ia(0, 1269, b), S = d, (b = 0) | b)
                        },
                        _csmGetParameterMinimumValues: function (a) {
                            var b = 0, d = S;
                            return S = S + 16 | 0, b = d, (a |= 0) ? (b = 0 | c[928 + (0 | c[a >> 2]) >> 2], S = d, 0 | b) : (c[b >> 2] = 1671, c[b + 4 >> 2] = 1411, ia(0, 1269, b), S = d, (b = 0) | b)
                        },
                        _csmGetParameterTypes: function (a) {
                            var b = 0, d = S;
                            return S = S + 16 | 0, b = d, (a |= 0) ? (b = 0 | c[a + 548 >> 2], S = d, 0 | b) : (c[b >> 2] = 1650, c[b + 4 >> 2] = 1411, ia(0, 1269, b), S = d, (b = 0) | b)
                        },
                        _csmGetParameterValues: function (a) {
                            var b = 0, d = S;
                            return S = S + 16 | 0, b = d, (a |= 0) ? (b = 0 | c[a + 552 >> 2], S = d, 0 | b) : (c[b >> 2] = 1758, c[b + 4 >> 2] = 1411, ia(0, 1269, b), S = d, (b = 0) | b)
                        },
                        _csmGetPartCount: function (a) {
                            var b = 0, d = S;
                            return S = S + 16 | 0, b = d, (a |= 0) ? (b = 0 | c[a + 4 >> 2], S = d, 0 | b) : (c[b >> 2] = 1780, c[b + 4 >> 2] = 1411, ia(0, 1269, b), S = d, -1)
                        },
                        _csmGetPartIds: function (a) {
                            var b = 0, d = S;
                            return S = S + 16 | 0, b = d, (a |= 0) ? (b = 0 | c[712 + (0 | c[a >> 2]) >> 2], S = d, 0 | b) : (c[b >> 2] = 1796, c[b + 4 >> 2] = 1411, ia(0, 1269, b), S = d, (b = 0) | b)
                        },
                        _csmGetPartOpacities: function (a) {
                            var b = 0, d = S;
                            return S = S + 16 | 0, b = d, (a |= 0) ? (b = 0 | c[a + 52 >> 2], S = d, 0 | b) : (c[b >> 2] = 1810, c[b + 4 >> 2] = 1411, ia(0, 1269, b), S = d, (b = 0) | b)
                        },
                        _csmGetPartParentPartIndices: function (a) {
                            var b = 0, d = S;
                            return S = S + 16 | 0, b = d, (a |= 0) ? (b = 0 | c[740 + (0 | c[a >> 2]) >> 2], S = d, 0 | b) : (c[b >> 2] = 1830, c[b + 4 >> 2] = 1411, ia(0, 1269, b), S = d, (b = 0) | b)
                        },
                        ...
                        _csmMallocModelAndInitialize: function (a) {
                            var b = 0, e = 0, f = S;
                            return S = S + 16 | 0, b = f, 0 != (0 | (a |= 0)) && 0 == (0 | Ic(b, 16, e = 0 | Ha(a))) ? (b = 0 | Ia(a, a = 0 | c[b >> 2], e)) || (Fc(a), b = 0) : b = 0, S = f, 0 | b
                        },
                        _csmReadCanvasInfo: function (a, b, d, e) {
                            b |= 0, d |= 0, e |= 0;
                            var f, g, h, i = 0, j = S;
                            if (S = S + 32 | 0, g = j + 24 | 0, i = j + 16 | 0, h = j + 8 | 0, f = j, a |= 0) return b ? d ? e ? (i = 0 | c[708 + (0 | c[a >> 2]) >> 2], c[b >> 2] = c[i + 12 >> 2], c[b + 4 >> 2] = c[i + 16 >> 2], c[d >> 2] = c[i + 4 >> 2], c[d + 4 >> 2] = c[i + 8 >> 2], c[e >> 2] = c[i >> 2]) : (c[g >> 2] = 1393, c[4 + g >> 2] = 1487, ia(0, 1269, g)) : (c[i >> 2] = 1393, c[i + 4 >> 2] = 1458, ia(0, 1269, i)) : (c[h >> 2] = 1393, c[4 + h >> 2] = 1431, ia(0, 1269, h)), void (S = j);
                            c[f >> 2] = 1393, c[f + 4 >> 2] = 1411, ia(0, 1269, f), S = j
                        },
                        _csmResetDrawableDynamicFlags: function (a) {
                            var b, d = S;
                            S = S + 16 | 0, b = d, (a |= 0) ? c[a + 428 >> 2] = 1 : (c[b >> 2] = 2318, c[b + 4 >> 2] = 1411, ia(0, 1269, b)), S = d
                        },
                        _csmReviveMocInPlace: function (a, b) {
                            b |= 0;
                            var e, d = 0, f = 0, g = S;
                            return S = S + 32 | 0, f = g + 16 | 0, e = g + 8 | 0, d = g, (a |= 0) ? ((d = a) + 63 & -64 | 0) != (0 | d) ? (c[e >> 2] = 1322, c[4 + e >> 2] = 1342, ia(0, 1269, e), S = g, (f = 0) | f) : 0 | b && (b + 63 & -64 | 0) == (0 | b) ? (f = 0 | qa(a), S = g, 0 | f) : (c[f >> 2] = 1322, c[f + 4 >> 2] = 1374, ia(0, 1269, f), S = g, (f = 0) | f) : (c[d >> 2] = 1322, c[d + 4 >> 2] = 1303, ia(0, 1269, d), S = g, (f = 0) | f)
                        },
                        ...
                        _csmUpdateModel: function (a) {
                            var b, d = S;
                            S = S + 16 | 0, b = d, (a |= 0) ? Gb(a) : (c[b >> 2] = 1595, c[b + 4 >> 2] = 1411, ia(0, 1269, b)), S = d
                        },
                ...
                xa = (b._free = q._free, b._i64Add = q._i64Add, b._i64Subtract = q._i64Subtract, b._malloc = q._malloc, b._memcpy = q._memcpy, b._memset = q._memset, b.establishStackSpace = q.establishStackSpace, b.stackAlloc = q.stackAlloc),
                ya = b.stackRestore = q.stackRestore, za = b.stackSave = q.stackSave;
            ...
            if (b.dynCall_ii = q.dynCall_ii, b.dynCall_iiii = q.dynCall_iiii, b.dynCall_iiiii = q.dynCall_iiiii, b.dynCall_vi = q.dynCall_vi, b.dynCall_vii = q.dynCall_vii, b.dynCall_viiiii = q.dynCall_viiiii, b.asm = q, b.ccall = function (a, c, d, f) {
                var g = {
                    string: function (a) {
                        var c = 0;
                        if (null != a && 0 !== a) {
                            var d = 1 + (a.length << 2), f = c = xa(d), g = M;
                            if (0 < d) {
                ...
                var a = b.memoryInitializerRequest, c = a.response;
        ...
        _em = ("object" == typeof exports && "object" == typeof module ? module.exports = _em_module : "function" == typeof define && define.amd ? define([], function () {
            return _em_module
        }) : "object" == typeof exports && (exports._em_module = _em_module), _em_module())
